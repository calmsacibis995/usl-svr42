...
#ident	"@(#)ucb:i386at/ucbcmd/mt/sundev/scsi.h	1.1"
#ident	"$Header: $"
...
struct scsi_ctlr {
	...
	u_char	c_last_phase;		/* last scsi bus phase */
...
struct scsi_disk {
	...
	u_char	un_flags;		/* special global unit flags,      */
...
struct scsi_tape {
	...
	u_char	un_openf;		/* tape open state */
	...
	u_char	un_hi_density;		/* high tape density/qic code */
	u_char	un_lo_density;		/* low tape density/qic code */
	u_char	un_hi_speed;		/* high tape speed code */
	u_char	un_lo_speed;		/* low tape speed code */
	u_char	un_flags;		/* special global unit flags,      */
					/*   disables disconnect/reconnect */
