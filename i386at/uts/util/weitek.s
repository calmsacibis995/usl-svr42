...
/	actual or intended publication of such source code.
	...
	.ident	"@(#)uts-x86at:util/weitek.s	1.4"
	.ident	"$Header: $"
...
restore_weitek:
	...
	popl	%ebp
	ret
	.size	restore_weitek,.-restore_weitek

/ Initialize the Weitek chip.

	.align	4
	.type	weitek_init,@function
	.globl	weitek_init
weitek_init:
	call	.init_wtimers
...
/ pending interrupts.
	...
	.align	4
	.type	reset_weitek_intr,@function
...
reset_weitek_intr:
	...
	popl	%edi
	ret
	.size	reset_weitek_intr,.-reset_weitek_intr
