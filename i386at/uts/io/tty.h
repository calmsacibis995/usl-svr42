...
#ifndef _IO_TTY_H	/* wrapper symbol for kernel use */
#define _IO_TTY_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/tty.h	1.7"
#ident	"$Header: $"
/*
...
struct tty {
	...
	struct xmap	*t_xmp;	/* ptr to extended tty structure */
...
extern struct chead cfreelist;	/* clist (cblock) free list */
...
/* sleep priorities for tty type devices */
#define	TTIPRI	28
#define	TTOPRI	29
...
#define	TBLOCK	010		/* Input is blocked */
...
#define	TTIOW	020000		/* Waiting for input/output condition to occur*/
				/* typically used for waiting for output to */
				/* drain on a close */
#define	TTXON	040000
