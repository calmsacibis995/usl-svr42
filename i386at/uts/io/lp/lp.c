...
#ident	"@(#)uts-x86at:io/lp/lp.c	1.8"
...
STATIC  int     lp_load(), lp_unload();
void	lpinit();

MOD_DRV_WRAPPER(lp, lp_load, lp_unload, NULL, DRVNAME);
