...
#ifndef _IO_MOUSE_MSE_H	/* wrapper symbol for kernel use */
#define _IO_MOUSE_MSE_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/mouse/mse.h	1.7"
#ident	"$Header: $"
...
struct mse_mon {
	...
	unchar		errno;		/* Error status from action */
};
