...
#ident	"@(#)uts-x86at:io/mouse/m320.c	1.12"
#ident	"$Header: $"
...
unsigned vect;
{
#define	MSE3_TIMEOUT_SPIN	500000
...
#ifdef MOUSEDEBUG
			cmn_err(CE_NOTE, "mse3intr: timeout!!!, state is %d",
							i8042_aux_state);
#endif
			clear_sickness();
		}
...
clear_sickness()
{
	...
	snd_320_cmd(MSEOFF, MSE_ACK, 1, buf);
	snd_320_cmd(MSEON, MSE_ACK, 1, buf);
