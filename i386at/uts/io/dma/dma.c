...
#ident	"@(#)uts-x86at:io/dma/dma.c	1.3"
#ident	"$Header: $"
...
int
#ifdef __STDC__
dma_prog(register struct dma_cb *dmacbptr,
	 register int chan,
	 unsigned char mode)
#else
...
int
#ifdef __STDC__
dma_swsetup(register struct dma_cb *dmacbptr,
	    register int chan,
	    unsigned char mode)
#else
...
void
#ifdef __STDC__
dma_swstart(register struct dma_cb *dmacbptr,
	    register int chan,
	    unsigned char mode)
#else
