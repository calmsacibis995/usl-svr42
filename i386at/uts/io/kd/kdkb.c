...
#ident	"@(#)uts-x86at:io/kd/kdkb.c	1.6"
#ident	"$Header: $"
...
wstation_t	*wsp;
{
	...
	Write8042DataByte(KB_READID);
	(void) Read8042DataByte(1);
...
register unchar	cmd;
{
	...
	kbstate_t	*kbp;
	int		oldpri;
	extern	short ws_ckbstate, ws_lkbstate;
