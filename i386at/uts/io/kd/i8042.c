...
#ident	"@(#)uts-x86at:io/kd/i8042.c	1.2"
#ident	"$Header: $"
...
/*
 *  on8042intr	-- Common 8042 device interrupt handler
 *
 *	Note that different 8042 devices interrupt at different IRQs.
 */
void
on8042intr(intrp)
int intrp;
...
/*
 *  getc8042	-- Get a data byte from the 8042
 *
...
/*
 * send8042, xmit8042	-- Send one data byte to a 8042 device
 *
 ...
 */
int
send8042(dev, obyte, ibyte)
int dev;
unsigned char obyte, *ibyte;
{
	int r, s;
...
/*
 *  able8042	-- Enable/disable 8042 devices
 *
...
/*
 *  rd42dat	-- Get next data byte from 8042
 *
...
/*
 *  wr42dat	-- Send one data byte to the 8042
 *
 *	Return value is the last-read 8042 status.
...
/*
 *  wr42cmd	-- Send a one byte command to the 8042
 *
 *	Return value is the last-read 8042 status.
