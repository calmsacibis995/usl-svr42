...
#ident	"@(#)uts-x86at:io/kd/kbmode.c	1.2"
#ident	"$Header: $"
...
keymap_t cn_keymap = { 141, {			/* number of scan codes */
/*  XT                                                     ALT     SPECIAL    */
...
#else
/* suppress cc empty translation unit warning */
