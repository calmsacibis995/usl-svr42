...
#ifndef _IO_HBA_HAD_H	/* wrapper symbol for kernel use */
#define _IO_HBA_HAD_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/hba/had.h	1.4"
#ident	"$Header: $"
...
struct wd_cdb_buf	/* HA driver CDB structure	*/
{
	buf_t		bp;
	char		cdb[MAX_CMDSZ];
};
