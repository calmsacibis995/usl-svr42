...
#ifndef _IO_HBA_WD7000_H	/* wrapper symbol for kernel use */
#define _IO_HBA_WD7000_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/hba/wd7000.h	1.3"
#ident	"$Header: $"
...
extern long wd_icmd();
extern void wd_xlat();
extern struct hbadata *wd_getblk();
extern long wd_freeblk();
extern void wd_getinfo();
extern int wd_open();
extern int wd_close();
extern int wd_ioctl();

#endif /* _IO_HBA_WD7000_H */
