...
#ifndef _IO_HBA_MCESDI_H	/* wrapper symbol for kernel use */
#define _IO_HBA_MCESDI_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/hba/mcesdi.h	1.2"
#ident	"$Header: $"
...
extern int mces_bdinit();
extern int mces_drvinit();
extern int mces_cmd();
extern struct gdev_parm_block *mces_int();
