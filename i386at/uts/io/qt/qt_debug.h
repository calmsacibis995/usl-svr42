...
#ifndef _IO_QT_QT_DEBUG_H	/* wrapper symbol for kernel use */
#define _IO_QT_QT_DEBUG_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/qt/qt_debug.h	1.4"
#ident	"$Header: $"
