...
#ifndef _IO_TARGET_FDISK_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_FDISK_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/target/fdisk.h	1.2"
#ident	"$Header: $"
