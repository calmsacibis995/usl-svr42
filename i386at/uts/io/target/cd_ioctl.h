...
#ifndef _IO_TARGET_CD_IOCTL_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_CD_IOCTL_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/target/cd_ioctl.h	1.5"
#ident	"$Header: $"
