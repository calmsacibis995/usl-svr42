...
#ifndef _IO_TARGET_TAPE_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_TAPE_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/target/tape.h	1.4"
#ident	"$Header: $"
