...
#ifndef _IO_TARGET_WORM_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_WORM_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/target/worm.h	1.2"
#ident  "$Header: $"
