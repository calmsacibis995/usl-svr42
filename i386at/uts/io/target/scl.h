...
#ifndef _IO_TARGET_SCL_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_SCL_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/target/scl.h	1.2"
#ident	"$Header: $"
