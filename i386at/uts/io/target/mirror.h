...
#ifndef _IO_TARGET_MIRROR_H	/* wrapper symbol for kernel use */
#define _IO_TARGET_MIRROR_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/target/mirror.h	1.2"
#ident	"$Header: $"
