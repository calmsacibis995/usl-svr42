...
#ifndef _IO_WS_CHAN_H	/* wrapper symbol for kernel use */
#define _IO_WS_CHAN_H	/* subject to change without notice */

#ident	"@(#)uts-x86at:io/ws/chan.h	1.5"
#ident	"$header: $"
...
#define CH_INFO ( ('I' << 8) | 'N')

#define CH_RAWMODE ( ('R' << 8) | 'M')
