...
/	Corporation and should be treated as Confidential.
	...
	.ident	"@(#)x286emul:syscalla.s	1.1.1.1"
...
/	system call #		<--- esp
	...
	/ newer executables expect %dx to hold the hi-order word, so we'll
	/ put it their too.  this occurs a little further down, after the
	/ stack segment register and pointer are restored
	movl    %eax, %ebx
