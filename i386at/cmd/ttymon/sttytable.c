...
#ident	"@(#)ttymon:i386at/cmd/ttymon/sttytable.c	1.7.6.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/ttymon/sttytable.c,v 1.1 91/02/28 20:16:09 ccs Exp $"
