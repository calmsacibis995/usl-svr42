...
#ident	"@(#)uts-comm:io/sad/sad.c	1.10.3.3"
#ident	"$Header: $"
...
int saddevflag = (D_INITPUB | D_NOSPECMACDATA ); /* security flag initialized to */
					/* device state to public */
					/* no MAC checks for data transfer */
/* control structure for covert channel limiter */
STATIC ccevent_t cc_re_sad = { CC_RE_SAD, CCBITS_RE_SAD };
