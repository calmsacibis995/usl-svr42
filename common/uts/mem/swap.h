...
#ident	"@(#)uts-comm:mem/swap.h	1.1.2.5"
#ident	"$Header: $"
...
struct	swapinfo {
	...
	struct	vnode *si_svp;		/* snode for this swap device */
	...
	struct	ianon *si_ianon;	/* pointer to indirect anon array */
	int	si_allocs;		/* # of conseq. allocs from this area */
	struct	swapinfo *si_next;	/* next swap area */
	short	si_flags;		/* flags defined above */
