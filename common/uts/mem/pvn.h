...
#ident	"@(#)uts-comm:mem/pvn.h	1.1.2.2"
#ident	"$Header: $"
 ...
 * This file declares the interfaces to common subroutines
...
int		pvn_getpages(/* getapage, vp, off, len, protp, pl, plsz,
				seg, addr, rw, cred */);
 ...
 * worth of bytes.  These numbers are chosen to be the minimum of the maxima
