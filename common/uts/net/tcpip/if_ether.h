...
#ifndef	_NET_TCPIP_IF_ETHER_H	/* wrapper symbol for kernel use */
#define	_NET_TCPIP_IF_ETHER_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/if_ether.h	1.2.5.4"
#ident	"$Header: $"
...
#ifndef _NET_TCPIP_IF_ARP_H
#include <net/tcpip/if_arp.h>	/* REQUIRED */
#endif
