...
#ifndef _NET_TCPIP_TCP_TIMER_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_TCP_TIMER_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/tcp_timer.h	1.2.3.1"
#ident	"$Header: $"
