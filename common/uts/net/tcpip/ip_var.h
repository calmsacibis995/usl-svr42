...
#ifndef _NET_TCPIP_IP_VAR_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_IP_VAR_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/ip_var.h	1.3.3.3"
#ident	"$Header: $"
...
#include <net/tcpip/byteorder.h>	/* REQUIRED */
#endif
