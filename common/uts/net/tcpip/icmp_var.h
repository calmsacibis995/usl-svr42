...
#ifndef _NET_TCPIP_ICMP_VAR_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_ICMP_VAR_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/icmp_var.h	1.2.3.2"
#ident	"$Header: $"
...
#ifndef _NET_TCPIP_IP_ICMP_H
#include <net/tcpip/ip_icmp.h>	/* REQUIRED */
#endif

#elif defined(_KERNEL)

#include <netinet/ip_icmp.h>	/* REQUIRED */
