...
#ifndef _NET_TCPIP_ARP_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_ARP_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/arp.h	1.2.3.1"
#ident	"$Header: $"
