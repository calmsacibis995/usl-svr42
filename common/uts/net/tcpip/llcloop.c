...
#ident	"@(#)uts-comm:net/tcpip/llcloop.c	1.3.3.3"
#ident	"$Header: $"
...
static struct module_info loopm_info[DRVR_INFO_SZ] = {
	LOOPM_ID, "llc_loop", 0, 8256, 16512, 1024,
	LOOPM_ID, "llc_loop", 0, 8256, 16512, 1024,
	LOOPM_ID, "llc_loop", 0, 8256, 16512, 1024
};
