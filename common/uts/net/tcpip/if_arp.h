...
#ifndef	_NET_TCPIP_IF_ARP_H	/* wrapper symbol for kernel use */
#define	_NET_TCPIP_IF_ARP_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/if_arp.h	1.2.4.3"
#ident	"$Header: $"
