...
#ifndef	_NET_TCPIP_IN_H	/* wrapper symbol for kernel use */
#define	_NET_TCPIP_IN_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/in.h	1.3.3.3"
#ident	"$Header: $"
