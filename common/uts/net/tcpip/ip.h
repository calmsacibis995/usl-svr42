...
#ifndef _NET_TCPIP_IP_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_IP_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/ip.h	1.5"
#ident	"$Header: $"
