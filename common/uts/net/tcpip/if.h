...
#ifndef	_NET_TCPIP_IF_H	/* wrapper symbol for kernel use */
#define	_NET_TCPIP_IF_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/if.h	1.3.3.2"
#ident	"$Header: $"
