...
#ifndef _NET_TCPIP_TCP_SEQ_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_TCP_SEQ_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/tcp_seq.h	1.2.3.2"
#ident	"$Header: $"
