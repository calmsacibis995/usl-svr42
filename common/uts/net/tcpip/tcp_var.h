...
#ifndef _NET_TCPIP_TCP_VAR_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_TCP_VAR_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/tcp_var.h	1.3.3.2"
#ident	"$Header: $"
...
#ifndef _NET_TCPIP_TCP_TIMER_H
#include <net/tcpip/tcp_timer.h>	/* REQUIRED */
#endif
