...
#ifndef _NET_TRANSPORT_TIHDR_H	/* wrapper symbol for kernel use */
#define _NET_TRANSPORT_TIHDR_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/transport/tihdr.h	1.4.2.2"
#ident	"$Header: $"
