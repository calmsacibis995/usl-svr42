...
#ident	"@(#)uts-comm:net/rpc/xdr_mblk.c	1.4.2.4"
#ident	"$Header: $"
...
STATIC	bool_t	xdrmblk_getlong(), xdrmblk_putlong();
STATIC	bool_t	xdrmblk_getbytes(), xdrmblk_putbytes();
STATIC	u_int	xdrmblk_getpos();
STATIC	bool_t	xdrmblk_setpos();
STATIC	long *	xdrmblk_inline();
STATIC	void	xdrmblk_destroy();

/*
 * Xdr on mblks operations vector.
 */
STATIC struct xdr_ops xdrmblk_ops = {
	xdrmblk_getlong,
	xdrmblk_putlong,
	xdrmblk_getbytes,
	xdrmblk_putbytes,
