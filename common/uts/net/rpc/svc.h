...
#ident	"@(#)uts-comm:net/rpc/svc.h	1.4.3.5"
#ident	"$Header: $"
 ...
 */
#ifdef __STDC__
int	svc_tli_kcreate(struct file *, u_int, SVCXPRT **);
bool_t	svc_register(SVCXPRT *, u_long, u_long, void (*)(), int);
void	svc_unregister(u_long, u_long);
int	svc_clts_kdup_throw(struct svc_req *);
int	svc_clts_kdup_reply(struct svc_req *);
void	svc_clts_kdupstart(struct svc_req *);
void	svc_clts_kdupend(struct svc_req *, int);
int	svc_clts_kcreate(TIUSER *, u_int, SVCXPRT **);
#else
int	svc_tli_kcreate();
bool_t	svc_register();
void	svc_unregister();
int	svc_clts_kdup_throw();
int	svc_clts_kdup_reply();
void	svc_clts_kdupstart();
void	svc_clts_kdupend();
#endif /* __STDC__ */
