...
#ident	"@(#)uts-comm:net/rpc/auth_des.c	1.5.2.2"
#ident	"$Header: $"
/*
...
#include <net/tcpip/in.h>	/* XXX: just to get htonl() and ntohl() */
...
/* ARGSUSED */
STATIC bool_t
authdes_marshal(auth, xdrs, addr)
	AUTH *auth;
	XDR *xdrs;
	struct netbuf *addr;	/* used only by AUTH_ESV */
{
