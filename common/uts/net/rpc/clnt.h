...
#ident	"@(#)uts-comm:net/rpc/clnt.h	1.5.3.7"
#ident	"$Header: $"
...
#ifndef _NET_RPC_RPC_COM_H
#include <net/rpc/rpc_com.h> /* SVR4.0COMPAT */
#endif
 ...
 */
#if defined(__STDC__)
const char *clnt_sperrno(const enum clnt_stat);	/* string */
#else
...
#ifndef _NET_RPC_CLNT_SOC_H
#include <net/rpc/clnt_soc.h> /* SVR4.0COMPAT */
#endif
...
/* clnt_clts internal kernel routines  */
#ifdef __STDC__
void	clnt_clts_reopen(CLIENT *, u_long, u_long, struct knetconfig *);
void	clnt_clts_setxid(CLIENT *, int);
int	clnt_clts_getxid(void);
int	clnt_clts_settimers(CLIENT *, struct rpc_timers *, struct rpc_timers *, unsigned int, void (*)(), caddr_t);
void	clnt_clts_init(CLIENT *, struct netbuf *, int, struct cred *);
int	clnt_clts_kcreate(TIUSER *, dev_t, struct netbuf *, u_long, u_long, u_int, int, struct cred *, CLIENT **);
int	clnt_tli_kcreate(struct knetconfig *, struct netbuf *, u_long, u_long, u_int, int, struct cred *, CLIENT **);
#else
void	clnt_clts_reopen();
void	clnt_clts_setxid();
int	clnt_clts_getxid();
int	clnt_clts_settimers();
void	clnt_clts_init();
int	clnt_clts_kcreate();
int	clnt_tli_kcreate();
#endif /* __STDC__ */
