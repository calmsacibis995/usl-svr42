...
#ident	"@(#)uts-comm:net/loopback/ticots.c	1.7.5.5"
#ident	"$Header: $"
...
int tcodevflag = D_OLD;

#define DRVNAME "ticots - Loadable TPI loopback transport provider."

STATIC int	tco_load();

MOD_DRV_WRAPPER(tco, tco_load, NULL, NULL, DRVNAME);
