...
#ident	"@(#)uts-comm:net/loopback/ticlts.c	1.9.2.7"
#ident	"$Header: $"
...
int tcldevflag = D_OLD;

#define DRVNAME "ticlts - Loadable TPI loopback transport provider."

STATIC	int	tcl_load();

MOD_DRV_WRAPPER(tcl, tcl_load, NULL, NULL, DRVNAME);
