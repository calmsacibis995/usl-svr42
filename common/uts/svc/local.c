...
#ident	"@(#)uts-comm:svc/local.c	1.3.4.1"
#ident	"$Header: $"
...
STATIC int nclentry = sizeof(clentry)/sizeof(struct sysent);


#ifndef NODEBUGGER
STATIC char *clenames[] = {	/* names for CLOCAL debug printout */
	"=ERROR=",              /* 0 */
};
#endif /* NODEBUGGER */
