...
#ident	"@(#)uts-comm:fs/nfs/nfs_clnt.h	1.5.2.3"
#ident	"$Header: $"
...
struct mntinfo {
	...
	int		 mi_protocol;	/* protocol version (NFS_V2/NFS_ESV) */
	lid_t		 mi_lid;	/* mount point LID for old servers */
	lid_t		 mi_esvlid;	/* mount point LID for old servers ESV */
