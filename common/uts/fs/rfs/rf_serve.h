...
#ifndef  _FS_RFS_RF_SERVE_H
#define  _FS_RFS_RF_SERVE_H

#ident	"@(#)uts-comm:fs/rfs/rf_serve.h	1.6.2.2"
#ident	"$Header: $"
/*
...
#ifndef _FS_RFS_RF_ADV_H
#include <fs/rfs/rf_adv.h>	/* REQUIRED */
#endif
...
typedef struct rfsr_state {
	...
	rd_user_t	*sr_rdup;	/* client file reference */
} rfsr_state_t;
