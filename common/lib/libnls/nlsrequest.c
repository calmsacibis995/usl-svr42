...
#ident	"@(#)libnls:common/lib/libnls/nlsrequest.c	1.5.4.1"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnls/nlsrequest.c,v 1.1 91/02/28 20:49:15 ccs Exp $"
