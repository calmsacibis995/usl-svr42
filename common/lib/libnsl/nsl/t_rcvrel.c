...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/t_rcvrel.c	1.7.7.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/t_rcvrel.c,v 1.1 91/02/28 20:52:13 ccs Exp $"
#include "sys/param.h"
#include "sys/types.h"
#include "sys/errno.h"
