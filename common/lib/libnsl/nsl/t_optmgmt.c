...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/t_optmgmt.c	1.3.8.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/t_optmgmt.c,v 1.1 91/02/28 20:52:06 ccs Exp $"
#include "sys/param.h"
#include "sys/types.h"
#include "sys/errno.h"
