...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/_utility.c	1.11.5.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/_utility.c,v 1.1 91/02/28 20:51:40 ccs Exp $"
#include "sys/param.h"
#include "sys/types.h"
#include "sys/errno.h"
