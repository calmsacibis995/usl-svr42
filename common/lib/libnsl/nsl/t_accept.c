...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/t_accept.c	1.5.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/t_accept.c,v 1.1 91/02/28 20:51:45 ccs Exp $"
#include "sys/param.h"
#include "sys/types.h"
#include "sys/errno.h"
