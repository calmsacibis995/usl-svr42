...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/t_alloc.c	1.4.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/t_alloc.c,v 1.1 91/02/28 20:51:46 ccs Exp $"
#include "sys/types.h"
