...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/t_getinfo.c	1.5.4.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/t_getinfo.c,v 1.1 91/02/28 20:51:56 ccs Exp $"
#include "sys/errno.h"
#include "sys/types.h"
