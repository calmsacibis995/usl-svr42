...
#ident	"@(#)libnsl:common/lib/libnsl/nsl/_errlst.c	1.3.4.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libnsl/nsl/_errlst.c,v 1.1 91/02/28 20:51:35 ccs Exp $"
