...
#ident	"@(#)libnsl:common/lib/libnsl/rpc/rpc.mk	1.9.14.4"
#ident "$Header: rpc.mk 1.3 91/03/14 $"
...
LOCALDEF=-DPORTMAP -D_NSL_RPC_ABI -DYP $(PICFLAG)
...
OBJS =	$(SECOBJS) $(INETOBJS)  auth_none.o auth_sys.o authsys_prot.o \
	...
	xdr.o xdr_array.o xdr_float.o xcrypt.o\
