...
#ident	"@(#)libnsl:common/lib/libnsl/rpc/rpcb_clnt.c	1.10.9.4"
#ident  "$Header: rpcb_clnt.c 1.2 91/06/26 $"
...
static struct timeval tottimeout = { 30, 0 };
