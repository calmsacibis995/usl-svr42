...
#ident	"@(#)libnsl:common/lib/libnsl/rpc/clnt_dg.c	1.3.9.5"
#ident  "$Header: clnt_dg.c 1.3 91/09/20 $"
...
send_again:
	 ...
	 */
	if (utimeout.tv_sec == 0 && utimeout.tv_usec == 0) {
	...
	CLIENT *cl;
{
	...
	(void) mem_free(cu->cu_raddr.buf, cu->cu_raddr.maxlen);
