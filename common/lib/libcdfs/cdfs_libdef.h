...
#ident	"@(#)libcdfs:common/lib/libcdfs/cdfs_libdef.h	1.4"
#ident	"$Header: $"
...
static int			cd_GetDevName (char *, char *);
...
static boolean_t	cd_FsMember (char *);
static boolean_t	cd_IsMntPt (char *, struct mnttab *);
