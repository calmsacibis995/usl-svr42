...
#ident	"@(#)libc-port:gen/ttyname.c	1.30"
 ...
 */
	if ( !isatty(f) || fstat(f, &fsb) < 0 || !S_ISCHR(fsb.st_mode) )
		return(0);
...
static int
srch_dir(path, plen, pflags, depth, fsb, date )
