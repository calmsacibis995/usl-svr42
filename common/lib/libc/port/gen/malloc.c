...
#ident	"@(#)libc-port:gen/malloc.c	1.32"
...
size_t		size;
	...
	if((((size_t)addr) % WORDSIZE) != 0)
		offset = WORDSIZE - (size_t)addr%WORDSIZE;
	else
		offset = 0;
