...
#ident	"@(#)rtld:common/externs.h	1.10"
...
extern int _rtld ARGS((Elf32_Dyn *interface, Elf32_Dyn **rt_ret, int init));
...
extern int _so_find ARGS((CONST char *fname, char ***names));
...
extern int _rt_ismember(struct rt_private_map *, struct rt_private_map *);
extern void _rt_addset(unsigned long, struct rt_private_map *);
extern void _rt_delset(unsigned long, struct rt_private_map *);
