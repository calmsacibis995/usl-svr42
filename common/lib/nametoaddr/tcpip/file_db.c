...
#ident	"@(#)nametoaddr:common/lib/nametoaddr/tcpip/file_db.c	1.3.4.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/nametoaddr/tcpip/file_db.c,v 1.1 91/02/28 21:05:54 ccs Exp $"
