...
#ident	"@(#)nametoaddr:common/lib/nametoaddr/resolv/libsocket/socket/socketpair.c	1.1.5.3"
#ident  "$Header: socketpair.c 1.2 91/06/26 $"
...
struct netconfig * _rs__s_match();
struct _si_user * _rs__s_open();
extern int	errno;
extern char	*calloc();
