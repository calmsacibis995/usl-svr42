...
/*LINTLIBRARY*/
#ident	"@(#)libadm:common/lib/libadm/ckrange.c	1.3.5.4"
#ident  "$Header: $"
...
#define PROMPT		"Enter a base %d integer between the decimal values %ld and %ld"
#define MESG10		"Please enter an integer between %ld and %ld."
#define MESG		"Please enter a base %d integer between the decimal values %ld and %ld."
