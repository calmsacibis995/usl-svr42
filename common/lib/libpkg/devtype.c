...
/*LINTLIBRARY*/
#ident	"@(#)libpkg:common/lib/libpkg/devtype.c	1.3.8.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libpkg/devtype.c,v 1.1 91/02/28 20:55:06 ccs Exp $"
#include <stdio.h>
#include <string.h>
#include <pkgdev.h>
