...
#ident	"@(#)curses:common/lib/xlibcurses/screen/doprnt.c	1.10.2.4"
#ident  "$Header: doprnt.c 1.2 91/06/26 $"
/*
...
/* Picking most of the variable values from lib-port:print/print.h */
