...
#ident	"@(#)curses:common/lib/xlibcurses/screen/setupterm.c	1.57.2.4"
#ident  "$Header: setupterm.c 1.2 91/06/26 $"
#ifndef	NOBLIT
...
#ifdef	TIOCGWINSZ
	    /*
	     * ioctls for 4.3BSD and others that have adopted TIOCGWINSZ
	     */
	    {
		struct	winsize	w;
