...
#ident	"@(#)ksh:include/national.h	1.1.6.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/ksh/include/national.h,v 1.1 91/02/28 17:40:10 ccs Exp $"


/* @(#)ksh:include/national.h	1.1.6.3 */
