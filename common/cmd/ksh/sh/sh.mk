...
#ident	"@(#)ksh:sh/sh.mk	1.5"
#ident "$Header: sh.mk 1.3 91/04/29 $"
...
LOCALINC = -I$(KSHINC)
LOCALDEF = -DKSHELL
LDLIBS   = ../shlib/libsh.a

SOURCES = args.c arith.c builtin.c cmd.c ctype.c defs.c echo.c \
	edit.c emacs.c error.c expand.c fault.c history.c \
	io.c jobs.c macro.c main.c msg.c name.c print.c service.c \
	stak.c string.c test.c vfork.c vi.c word.c xec.c
...
all:  $(OBJECTS)
	$(CC) -o ksh $(OBJECTS) $(LDFLAGS) $(LDLIBS) $(SHLIBS)
