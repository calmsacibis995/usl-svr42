...
#ident	"@(#)oampkg:common/cmd/oampkg/pkgremove/check.c	1.7.8.2"
#ident  "$Header: $"
#include <stdio.h>
#include <limits.h>
#include <string.h>
...
#define MSG_PRIV \
	...
	impact and which will be executed during the process of removing \
	this package."
#define HLP_PRIV \
	...
	removed, answer 'y' to continue the removal process."
