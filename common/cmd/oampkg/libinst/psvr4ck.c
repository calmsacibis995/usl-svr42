...
/*LINTLIBRARY*/
#ident	"@(#)oampkg:common/cmd/oampkg/libinst/psvr4ck.c	1.7.10.3"
#ident  "$Header: $"
...
#define MSG_RCONFLICT \
	"The following files are currently being used by other \
	packages on the system, and may be removed by the \
	removal of this pre-SVR4 package:"
...
#define HLP_RCONFLICT \
	"If you choose to continue removal, it is possible that you \
	will remove files which are part of another package that is \
	already installed on the system.  If you want to assure that the \
	files are not removed, answer 'n' to stop the installation \
	process."
#define MSG_NOTVER \
