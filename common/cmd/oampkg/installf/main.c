...
#ident	"@(#)oampkg:common/cmd/oampkg/installf/main.c	1.13.11.2"
...
usage()
{
	...
	if(REMOVEF) {
		...
		(void) fprintf(stderr, "\t\tf <mode> <owner> <group> [<mac> <fixed> <inherited>]\n"); 
		(void) fprintf(stderr, "\t\tv <mode> <owner> <group> [<mac> <fixed> <inherited>]\n"); 
		(void) fprintf(stderr, "\t\te <mode> <owner> <group> [<mac> <fixed> <inherited>]\n"); 
		(void) fprintf(stderr, "\t\td <mode> <owner> <group> [<mac> <fixed> <inherited>]\n"); 
		(void) fprintf(stderr, "\t\tx <mode> <owner> <group> [<mac> <fixed> <inherited>]\n"); 
		(void) fprintf(stderr, "\t\tp <mode> <owner> <group> [<mac> <fixed> <inherited>]\n"); 
		(void) fprintf(stderr, 
