...
#ident	"@(#)oampkg:common/cmd/oampkg/installf/installf.c	1.10.11.2"
...
#define ERR_MAC		"invalid MAC level <%s> specified for <%s>"
...
#define ERR_SECALL	"either all security fields must be specified or none"
#define ERR_PATH	"invalid pathname"
