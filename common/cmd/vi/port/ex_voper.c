...
#ident	"@(#)vi:port/ex_voper.c	1.18.1.6"
#ident  "$Header: ex_voper.c 1.2 91/06/27 $"
#include "ex.h"
#include "ex_tty.h"
#include "ex_vis.h"
#include <regexpr.h>
...
errlab:
			beep();
			/* If we got an error while in open/append/insert
			 * type modes and showmode is on, the status line 
			 * will be out of date so clear it.
			 */
			vshowmode("");
			vmacp = 0;
			return;
