...
#ident	"@(#)vi:port/ex_vis.h	1.10.1.5"
#ident  "$Header: ex_vis.h 1.2 91/06/27 $"
/*
 * Ex version 3
 *
...
var	bool	splitw;
/*
 * vsmdclr: vshowmode clear, is a flag to clear  showmode 
 * message when it is set to 1.
 *
 * vsmdclr is 1, if map() failed to macpush() when an ESCAPE  
 * is not the first character of a macro. That means to end
 * a command. 
 */
var	bool	vsmdclr;
