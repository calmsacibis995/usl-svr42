...
#ident	"@(#)localedef:common/cmd/localedef/chrtbl/chrtbl.c	1.1.8.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/localedef/chrtbl/chrtbl.c,v 1.1 91/02/28 17:44:24 ccs Exp $"
/*
