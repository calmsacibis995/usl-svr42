...
#ident	"@(#)localedef:common/cmd/localedef/montbl/montbl.c	1.2.6.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/localedef/montbl/montbl.c,v 1.1 91/02/28 17:45:00 ccs Exp $"
