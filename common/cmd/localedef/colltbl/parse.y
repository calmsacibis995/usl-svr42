...
%{
#ident	"@(#)localedef:common/cmd/localedef/colltbl/parse.y	1.1.7.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/localedef/colltbl/parse.y,v 1.1 91/02/28 17:44:45 ccs Exp $"
