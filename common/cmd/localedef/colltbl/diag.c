...
#ident	"@(#)localedef:common/cmd/localedef/colltbl/diag.c	1.1.5.1"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/localedef/colltbl/diag.c,v 1.1 91/02/28 17:44:41 ccs Exp $"
#include <stdio.h>
#include <varargs.h>
#include "colltbl.h"
#define SYNERR		0
