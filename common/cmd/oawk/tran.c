...
#ident	"@(#)oawk:tran.c	1.1.2.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/oawk/tran.c,v 1.1 91/02/28 19:19:58 ccs Exp $"
#include "stdio.h"
#include "awk.def"
#include "awk.h"
...
/*imb*/
        ...
        if ((vp->tval & (NUM | STR)) == 0)
                error(FATAL, "funny variable %o: %s %s %g %o", vp,
			vp->nval ? vp->nval : "",
                        vp->sval ? vp->sval : "",
			vp->fval, vp->tval);
/*imb*/
