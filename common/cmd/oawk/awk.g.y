...
%{
#ident	"@(#)oawk:awk.g.y	1.1.2.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/oawk/awk.g.y,v 1.1 91/02/28 19:19:31 ccs Exp $"
%}
...
simple_stat:
	...
	| expr	{ $$ = exptostat($1); }
	|		{ $$ = (int)0; }
	| error		{ yyclearin; yyerror("illegal statement"); return;}
	;
