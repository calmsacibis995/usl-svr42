...
#ident	"@(#)oawk:lib.c	1.1.2.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/oawk/lib.c,v 1.1 91/02/28 19:19:43 ccs Exp $"
#include "stdio.h"
#include "awk.def"
#include "awk.h"
#include "ctype.h"
