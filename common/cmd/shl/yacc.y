...
%{
#ident	"@(#)shl:yacc.y	1.3.5.1"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/shl/yacc.y,v 1.1 91/02/28 20:09:42 ccs Exp $"
%}
%{
#include	"defs.h"
...
input_line		:	cmd 						{
				...
				|	error						{
													pfmt(stderr, MM_ERROR, ":52:Syntax error\n")
													;
												}
