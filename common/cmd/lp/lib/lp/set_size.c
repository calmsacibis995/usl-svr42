...
#ident	"@(#)lp:lib/lp/set_size.c	1.15.1.3"
#ident	"$Header: $"
...
#endif
{
	...
	if (which == 'W') {
		...
		(void) tidbit ((char *)0, "cols", &curval);

		if (output_res_char == -1)
			(void) tidbit ((char *)0, "orc", &output_res_char);
		output_res = output_res_char;

		if (output_res_horz_inch == -1)
			(void) tidbit ((char *)0, "orhi", &output_res_horz_inch);
		output_res_inch = output_res_horz_inch;

	} else {

		(void) tidbit ((char *)0, "lines", &curval);

		if (output_res_line == -1)
			(void) tidbit ((char *)0, "orl", &output_res_line);
		output_res = output_res_line;

		if (output_res_vert_inch == -1)
			(void) tidbit ((char *)0, "orvi", &output_res_vert_inch);
	...
	if (which == 'W') {
		...
		(void) tidbit ((char *)0, "smgl", &set_margin1);
		(void) tidbit ((char *)0, "smgr", &set_margin2);
		(void) tidbit ((char *)0, "smglp", &set_margin1_parm);
		(void) tidbit ((char *)0, "smgrp", &set_margin2_parm);
		(void) tidbit ((char *)0, "smglr", &set_both_margins);

		(void) tidbit ((char *)0, "cr", &carriage_return);
		(void) tidbit ((char *)0, "cuf", &parm_right_cursor);
		(void) tidbit ((char *)0, "hpa", &column_address);
		(void) tidbit ((char *)0, "rep", &repeat_char);
		(void) tidbit ((char *)0, "cuf1", &cursor_right);
		...
		(void) tidbit ((char *)0, "smgt", &set_margin1);
		(void) tidbit ((char *)0, "smgb", &set_margin2);
		(void) tidbit ((char *)0, "smgtp", &set_margin1_parm);
		(void) tidbit ((char *)0, "smgbp", &set_margin2_parm);
		(void) tidbit ((char *)0, "smgtb", &set_both_margins);
		...
		(void) tidbit ((char *)0, "slines", &slines);
		if (!OKAY(slines))
			(void) tidbit ((char *)0, "u9", &slines);

		(void) tidbit ((char *)0, "cud", &parm_down_cursor);
		(void) tidbit ((char *)0, "vpa", &row_address);
		(void) tidbit ((char *)0, "cud1", &cursor_down);
	...
	if (
		...
		if (putout) {
			...
			if (!cleared_margins_already) {
				(void) tidbit ((char *)0, "mgc", &clear_margins);
