...
#ident	"@(#)lp:filter/postscript/font/font.mk	1.4.7.2"
#ident "$Header: font.mk 1.3 91/04/18 $"
#ident	"@(#)lp:filter/postscript/font/font.mk	1.4.7.2"
...
realinstall : devpost bothinstall
	cd devpost; \
	ls *.out \
	| xargs -i $(INS) -m 444 -u $(OWNER) -g $(GROUP) -f $(FONTDIR)/devpost {}
...
install : makedev bothinstall
	$(INS) -m 555 -u $(OWNER) -g $(GROUP) -f $(FONTDIR) makedev
	$(INS) -m 555 -u $(OWNER) -g $(GROUP) -f $(FONTDIR)/devpost devpost/LINKFILE
	cd devpost; \
	ls $(ASCII) \
	| xargs -i $(INS) -m 444 -u $(OWNER) -g $(GROUP) -f $(FONTDIR)/devpost {}
...
bothinstall :
	...
	| xargs -i $(INS) -m 444 -u $(OWNER) -g $(GROUP) -f $(FONTDIR)/devpost/charlib {}

devpost ::
	@$(MAKE) -f $(MAKEFILE) $(MAKEARGS) makedev
	cd devpost; ../makedev $(ASCII); sh LINKFILE

makedev : $(COMMONDIR)/dev.h makedev.c
	$(CC) $(CFLAGS) $(DEFLIST) -o makedev makedev.c $(LDFLAGS) $(SHLIBS)
