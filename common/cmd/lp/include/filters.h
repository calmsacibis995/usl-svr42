...
#ident	"@(#)lp:include/filters.h	1.10.6.5"
#ident	"$Header: $"
...
typedef struct SLOWPARM {
	char *			type;  /* current content (input) type */
	char *			modes; /* modes not handled during filtering */
	char *			pages; /* list of pages handled */
	short			copies;/* number of copies produced */
}			SLOWPARM;
...
FILTERTYPE	insfilter ( char ** , char * , char * , char * , char * , char ** , unsigned short * , SLOWPARM * , char *** );
