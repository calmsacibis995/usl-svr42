...
/*
*/
#ident	"@(#)lp:include/_networkMgmt.h	1.7.2.3"
#ident  "$Header: _networkMgmt.h 1.2 91/06/27 $"
...
extern	connectionInfo	*NewConnectionInfo (systemInfo *);
