...
#ident	"@(#)csh:common/cmd/csh/sh.glob.c	1.4.5.2"
#ident  "$Header: sh.glob.c 1.2 91/06/26 $"
...
/*
 * SysV's default 5120 is too small, the 10240 value is
 * consisent with the value (NCARGS) used in sh.h
 */
