 ...
 *	All Rights Reserved
 */
#ident	"@(#)fmli:wish/getstring.c	1.16.3.3"
...
prompt_help()
{
	...
	if (p.helpismenu)
	...
	else
	  {
	    ...
	    ** Added a 3-rd "p.helptitle" to the parameter list of
	    ** objop.
	    */
	    return objop("OPEN", "TEXT", "$VMSYS/OBJECTS/Text.help", p.helpfile, p.helptitle, p.helptitle, NULL);
	  }
    }
    else
	return(SUCCESS);
