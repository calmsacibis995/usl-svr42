 ...
 *	All Rights Reserved
 */
#ident	"@(#)fmli:vt/physical.c	1.30.3.4"
...
/* the current row of the mouse icon on the screen */
int Mouse_row;
/* the current column of the mouse icon on the screen */
int Mouse_col;
/* Open_mouse_mode is TRUE when the mouse may be used outside of a defined window on the screen */
