 ...
 *	All Rights Reserved
 */
#ident	"@(#)fmli:vt/highlight.c	1.8.3.3"
...
/* dmd TCB chtype Attr_show;	/* something visible (errors, etc) */
chtype Attr_visible;	/* the most annoying thing terminal can do */
chtype Attr_underline;	/* attribute of underline */
/* dmd TCB chtype Attr_mark;	/* attribute of "marked" items */
...
/* dmd TCB	Attr_visible = Attr_show = Attr_select = Attr_hide = Attr_highlight; */
	Attr_visible = Attr_select = Attr_hide = Attr_highlight;
	if (modes & A_DIM)
