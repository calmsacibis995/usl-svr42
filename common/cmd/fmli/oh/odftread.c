...
#ident	"@(#)fmli:oh/odftread.c	1.18.3.4"
...
/* dmd TCB */
static struct odft_entry FMLI_detab[MAXODFT] = {
...
#endif
		error(MUNGED, gettxt(":146","heuristics table") );
		continue;
	    }
...
#endif
		    error(MUNGED, gettxt(":147","heuristics magic number") );
		    continue;
		}
...
#endif
		error(MUNGED, gettxt(":148","heuristics table function") );
		continue;
	    }
	    offset++;
	}
