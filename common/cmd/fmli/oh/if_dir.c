 ...
 *	All Rights Reserved
 */
#ident	"@(#)fmli:oh/if_dir.c	1.45.3.7"
...
*/
		i = d_cols - 20 - strlen(entry->display) - 11;	/* dmd s15 */
...
char *argv[];
{
	...
	if ( argv[2] ) {
           ...
           i18n_length = strlen(i18n_string) - 3 * INT_SUBSTLEN;
	   ...
	   sprintf(msg, i18n_string,
	      ...
	      bsd_path_to_title( argv[2],(MESS_COLS-i18n_length)/3 ) );
           ...
           i18n_length = strlen(i18n_string) - 2 * INT_SUBSTLEN;
