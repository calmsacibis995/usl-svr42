...
/* the OOT entry for the view operation for Directory objects */
struct operation Dir_view = 
	{  Op_view,	NOBUT,	F_INT,	IF_DVI,	NULL,	OP_SNG, FALSE, NOMASK, NOMASK};
/* the OOT entry for the selection operation for Directory objects */
struct operation Dir_sh =
	{  Op_sh,	NOBUT,	F_INT,	IF_DSH,	NULL,	OP_BUT, FALSE, NOMASK, NOMASK};
/* the OOT entry for the execute operation for Directory objects */
...
/* The Object Operations Table ( OOT ) */
