...
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/ed/ed.c,v 1.1 91/02/28 16:56:13 ccs Exp $"
...
const struct {const sev; const char *msg, *id; } msgtab[] =
{
	...
	MM_ERROR,	"Maximum of 64 characters in file names",":185",/* 24 */
