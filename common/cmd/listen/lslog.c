...
#ident	"@(#)listen:lslog.c	1.7.8.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/listen/lslog.c,v 1.1 91/02/28 17:43:49 ccs Exp $"
...
void debug(int level, char *format, ...)
{
	...
	(void)fprintf(Debugfp, stamp(buf));
	(void)fflush (Debugfp);
}
#endif /*DEBUGMODE*/
