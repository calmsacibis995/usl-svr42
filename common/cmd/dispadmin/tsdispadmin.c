...
#ident	"@(#)dispadmin:common/cmd/dispadmin/tsdispadmin.c	1.5.6.3"
#ident  "$Header: tsdispadmin.c 1.2 91/06/26 $"

/***************************************************************************
 * Command: TSdispadmin
 *
 * Inheritable Privileges: P_TSHAR,P_SYSOPS
...
/*
 * Procedure: get_tsdptbl
 *
 * Notes: Retrieve the current ts_dptbl from memory, convert the time
...
/*
 * Procedure: set_tsdptbl
 *
 * Notes: Read the ts_dptbl values from infile, convert the time
