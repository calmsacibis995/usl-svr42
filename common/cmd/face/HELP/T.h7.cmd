...
Commands are used to take action on objects and text frames.  In FACE,
objects are forms and menus, and files that are accessed through the
Office. A text frame is used to display the tasks you are working on.
Commands can be executed from the Commands Menu, from the command
