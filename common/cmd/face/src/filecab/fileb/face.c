...
#ident	"@(#)face:src/filecab/fileb/face.c	1.8.5.3"
#ident  "$Header: face.c 1.9 91/11/26 $"
...
char	*object;
{
	fprintf(stderr, gettxt("uxface:30", "The permission of '%s' is not properly set for user '%s'.\n"), object, user);
	exit(1);
}
