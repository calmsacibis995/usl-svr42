...
#ident	"@(#)sfs.cmds:sfs/fstyp/fstyp.c	1.2.3.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/sfs/fstyp/fstyp.c,v 1.1 91/02/28 17:27:21 ccs Exp $"
 */
...
usage ()
{
	(void) fprintf (stderr, "sfs usage: fstyp [-v] special\n");
}
