...
#ident	"@(#)sfs.cmds:sfs/fsck/sfs_subr.c	1.1.3.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/sfs/fsck/sfs_subr.c,v 1.1 91/02/28 17:27:10 ccs Exp $"
