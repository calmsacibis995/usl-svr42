...
#ident	"@(#)sfs.cmds:sfs/fsck/utilities.c	1.4.4.5"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/sfs/fsck/utilities.c,v 1.1 91/02/28 17:27:14 ccs Exp $"
