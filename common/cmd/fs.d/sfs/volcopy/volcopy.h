...
#ident	"@(#)sfs.cmds:sfs/volcopy/volcopy.h	1.1.2.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/sfs/volcopy/volcopy.h,v 1.1 91/02/28 17:27:52 ccs Exp $"
...
#define STAT_PRVS	pm_work(P_MACREAD), pm_work(P_DACREAD)
