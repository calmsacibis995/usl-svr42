...
#ident	"@(#)s5.cmds:s5/labelit.c	1.31.1.11"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/s5/labelit.c,v 1.1 91/02/28 17:26:19 ccs Exp $"
...
char **argv;
{
	...
	if ((statarea.st_mode & S_IFMT) != S_IFBLK &&
		...
		fprintf(stderr, "labelit: ");
		fprintf(stderr, "%s is not special device\n", dev);
		exit(33);
	}
