...
# @(#)usr/src/common/cmd/fs.d/vxfs/mkfs/mkfs.mk	1.4 18 May 1992 18:27:25 - 
#ident	"@(#)vxfs.cmds:common/cmd/fs.d/vxfs/mkfs/mkfs.mk	1.4"
...
mkfs: mkfs.o $(LIBDIR)/libvxfs.a
	$(CC) $(LDFLAGS) -o $@ mkfs.o $(LIBDIR)/libvxfs.a $(LDLIBS) $(ROOTLIBS)

mkfs.dy: mkfs.o $(LIBDIR)/libvxfs.a
	$(CC) $(LDFLAGS) -o $@ mkfs.o $(LIBDIR)/libvxfs.a $(LDLIBS) $(SHLIBS)
