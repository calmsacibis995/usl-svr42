...
# @(#)usr/src/common/cmd/fs.d/vxfs/mount/mount.mk	1.4 18 May 1992 18:27:28 - 
#ident	"@(#)vxfs.cmds:common/cmd/fs.d/vxfs/mount/mount.mk	1.4"
...
mount: mount.o
	...
	$(CC) $(LDFLAGS) -o $@.dy $@.o $(LIBDIR)/libvxfs.a $(LDLIBS) $(SHLIBS)
