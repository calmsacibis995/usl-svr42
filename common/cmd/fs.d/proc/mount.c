...
#ident	"@(#)proc.cmds:proc/mount.c	1.4.5.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/proc/mount.c,v 1.1 91/02/28 17:25:29 ccs Exp $"

/***************************************************************************
 * Command: mount
 * Inheritable Privileges: P_MOUNT,P_DACWRITE,P_MACWRITE
 *       Fixed Privileges: None
 * Notes: mount the /proc file system
 *
 ***************************************************************************/
