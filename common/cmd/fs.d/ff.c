...
#ident	"@(#)fs.cmds:common/cmd/fs.d/ff.c	1.10.7.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ff.c,v 1.1 91/02/28 17:20:42 ccs Exp $"
#include	<stdio.h>
#include 	<limits.h>
#include	<string.h>
#include	<sys/fstyp.h>  
