...
#ident	"@(#)ufs.cmds:ufs/fsck/utilities.c	1.8.6.4"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/fsck/utilities.c,v 1.1 91/02/28 17:28:49 ccs Exp $"
