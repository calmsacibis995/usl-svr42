...
#ident	"@(#)ufs.cmds:ufs/fsck/ufs_tables.c	1.1.1.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/fsck/ufs_tables.c,v 1.1 91/02/28 17:28:45 ccs Exp $"
