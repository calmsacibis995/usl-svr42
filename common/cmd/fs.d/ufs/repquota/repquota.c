...
#ident	"@(#)ufs.cmds:ufs/repquota/repquota.c	1.8.8.4"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/repquota/repquota.c,v 1.1 91/02/28 17:29:45 ccs Exp $"
/*
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
