...
#ident	"@(#)ufs.cmds:ufs/quotaon/quotaon.c	1.9.10.4"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/quotaon/quotaon.c,v 1.1 91/02/28 17:29:41 ccs Exp $"
/*
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
