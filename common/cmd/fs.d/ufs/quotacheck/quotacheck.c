...
#ident	"@(#)ufs.cmds:ufs/quotacheck/quotacheck.c	1.8.8.6"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/quotacheck/quotacheck.c,v 1.1 91/02/28 17:29:37 ccs Exp $"
/*
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
int	quotactl (cmd, mountp, uid, addr)
	int		cmd;
	char		*mountp;
	int		uid;
	caddr_t		addr;
