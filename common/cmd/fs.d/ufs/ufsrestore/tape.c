...
#ident	"@(#)ufs.cmds:ufs/ufsrestore/tape.c	1.4.5.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/ufsrestore/tape.c,v 1.1 91/02/28 17:30:43 ccs Exp $"
