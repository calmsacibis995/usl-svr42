...
#ident	"@(#)ufs.cmds:ufs/ufsrestore/restore.c	1.2.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/ufsrestore/restore.c,v 1.1 91/02/28 17:30:37 ccs Exp $"
