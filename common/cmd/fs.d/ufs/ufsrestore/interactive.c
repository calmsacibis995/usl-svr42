...
#ident	"@(#)ufs.cmds:ufs/ufsrestore/interactive.c	1.4.5.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/ufsrestore/interactive.c,v 1.1 91/02/28 17:30:30 ccs Exp $"
