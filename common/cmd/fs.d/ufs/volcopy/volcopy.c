...
#ident	"@(#)ufs.cmds:ufs/volcopy/volcopy.c	1.8.10.5"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/volcopy/volcopy.c,v 1.1 91/02/28 17:30:51 ccs Exp $"
	...
	char 	*buf;
{
	...
	if (g_read(dev, fd, (char *)buf, BBSIZE) != BBSIZE) {
		perr(10, "Unable to read BB on input\n");
	}
