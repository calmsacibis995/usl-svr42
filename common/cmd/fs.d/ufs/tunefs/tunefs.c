...
#ident	"@(#)ufs.cmds:ufs/tunefs/tunefs.c	1.6.9.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/tunefs/tunefs.c,v 1.1 91/02/28 17:29:50 ccs Exp $"
/*
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	char *argv[];
{
	...
	FILE *vfstab;
	int i;
	int Aflag = 1;  	/* Alternate superblocks always updated */
	struct fstab *fs;
