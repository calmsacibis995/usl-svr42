...
#ident	"@(#)ufs.cmds:ufs/ufsdump/dumpmain.c	1.7.6.4"
#ident "$Header: dumpmain.c 1.2 91/09/30 $"
/*
 * +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	char	*argv[];
{
	...
	/* flush the last buffer, else ufsrestore requests a
	 * continuation tape and dump is not complet.
	 */
	spcl.c_type = TS_END;
	tflush(1);              
