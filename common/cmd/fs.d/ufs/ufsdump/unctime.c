...
#ident	"@(#)ufs.cmds:ufs/ufsdump/unctime.c	1.2.5.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/ufsdump/unctime.c,v 1.1 91/02/28 17:30:24 ccs Exp $"
