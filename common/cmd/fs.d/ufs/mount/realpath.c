...
#ident	"@(#)ufs.cmds:ufs/mount/realpath.c	1.2.5.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/mount/realpath.c,v 1.1 91/02/28 17:29:13 ccs Exp $"
