...
#ident	"@(#)ufs.cmds:ufs/fstyp/fstyp.c	1.5.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/ufs/fstyp/fstyp.c,v 1.1 91/02/28 17:28:55 ccs Exp $"
