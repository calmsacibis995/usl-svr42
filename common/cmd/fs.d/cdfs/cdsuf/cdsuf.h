...
#ident	"@(#)cdfs.cmds:cdfs/cdsuf/cdsuf.h	1.4"
#ident	"$Header: $"

/* Tabstops: 4 */

/*
 * Local include file for cdsuf(1M) utility.
 */
...
#define				MAXSUF			259				/* Maximum SUF length	*/
...
static int			Section = -1;					/* File section/default */
static uchar_t		SufBuf[MAXSUF];					/* Single SUF Buffer	*/
