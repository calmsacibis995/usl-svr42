...
#ident	"@(#)bfs.cmds:bfs/mount.c	1.7.8.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fs.d/bfs/mount.c,v 1.1 91/02/28 17:20:30 ccs Exp $"
	...
	register char *bs, *mp;
{
	...
	case ENOSPC:
		...
		break;
	case ENODEV:
		fprintf(stderr, "%s: %s no such device or write-protected\n", typename, bs);
		break;
	case ENOLOAD:
		fprintf(stderr, "bfs file system module cannot be loaded\n");
		break;
	default:
		perror(myname);
