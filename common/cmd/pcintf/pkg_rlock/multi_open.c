...
#ident	"@(#)pcintf:pkg_rlock/multi_open.c	1.1.1.2"
#include <sccs.h>

SCCSID(@(#)multi_open.c	3.2);	/* 8/21/91 21:42:04 */
...
/* 
   ...
   Outputs:
	Return Value: openFile table index or RL_FAIL (-1)
...
int		openSlot;		/* The open file slot */
	...
	/* Exclusion disallowed open - clean up and return RL_FAIL */
	/*
