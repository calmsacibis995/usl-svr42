...
#ident	"@(#)ttymon:common/cmd/ttymon/tmparse.c	1.1.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/ttymon/tmparse.c,v 1.1 91/02/28 20:16:24 ccs Exp $"
