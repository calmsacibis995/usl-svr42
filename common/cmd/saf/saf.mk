...
#ident	"@(#)saf:saf.mk	1.13.9.3"
#ident  "$Header: saf.mk 1.3 91/04/29 $"
...
sac: $(SACOBJ)
	if [ x$(CCSTYPE) = xCOFF ] ; \
	then \
	$(CC) -o sac $(SACOBJ) $(LDFLAGS) $(LDLIBS) $(COFFNSL) $(SHLIBS) ;\
	else \
	$(CC) -o sac $(SACOBJ) $(LDFLAGS) $(LDLIBS) $(ELFNSL) $(SHLIBS) ;\
	fi

sacadm: $(SACADMOBJ)
	if [ x$(CCSTYPE) = xCOFF ] ; \
	then \
	$(CC) -o sacadm $(SACADMOBJ) $(LDFLAGS) $(LDLIBS) $(COFFNSL) $(SHLIBS) ;\
	else \
	$(CC) -o sacadm $(SACADMOBJ) $(LDFLAGS) $(LDLIBS) $(ELFNSL) $(SHLIBS) ;\
	fi

pmadm: $(PMADMOBJ)
	if [ x$(CCSTYPE) = xCOFF ] ; \
	then \
	$(CC) -o pmadm $(PMADMOBJ) $(LDFLAGS) $(LDLIBS) $(COFFNSL) $(SHLIBS) ;\
	else \
	$(CC) -o pmadm $(PMADMOBJ) $(LDFLAGS) $(LDLIBS) $(ELFNSL) $(SHLIBS) ;\
	fi
