...
#ident	"@(#)ypcmd:ypinit.sh	1.6.9.3"
#ident  "$Header: ypinit.sh 1.2 91/06/25 $"
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
echo ""
echo "where:"
echo "	-c is used to set up a yp client"
echo "	-m is used to build a master yp server data base" 
echo "	-s is used for a slave data base and "
...
cp /tmp/.ypaliases $yproot_dir/aliases
rm /tmp/.ypaliases
