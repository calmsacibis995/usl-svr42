...
#ident	"@(#)devmgmt:common/cmd/devmgmt/getdev/main.c	1.5.11.2"
#ident  "$Header: main.c 1.4 91/06/27 $"
...
#define	M_USAGEMSG	":0:incorrect usage\n"
#define	M_USAGE	  ":0:usage: getdev [-ae] [criterion [...]] [device [...]]\n"
#define	M_CONSTY  ":0:Device Database in inconsistent state - notify administrator\n"
#define	M_DEVTAB  ":0:Device Database could not be opened for reading\n"
