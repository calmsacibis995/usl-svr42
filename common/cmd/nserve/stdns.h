...
#ident	"@(#)nserve:stdns.h	1.4.4.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/nserve/stdns.h,v 1.1 91/02/28 18:42:34 ccs Exp $"
/*
 *
...
/*
 *	should track contents of libns:stdns.h
 */
...
#define align(p)	(unsigned int)LALIGN(p)
