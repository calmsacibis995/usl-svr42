...
#ident	"@(#)devintf:common/cmd/devintf/devices/attrs/modify/modify.mk	1.5.7.2"
#ident "$Header: modify.mk 2.0 91/07/11 $"

include $(CMDRULES)

INSDIR		= $(USRSADM)/sysadm/menu/devices/devices/attrs/modify
OWN=bin
GRP=bin
