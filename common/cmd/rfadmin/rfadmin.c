...
#ident	"@(#)rfadmin:rfadmin.c	1.3.19.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/rfadmin/rfadmin.c,v 1.1 91/02/28 19:28:31 ccs Exp $"
#include <sys/types.h>
#include <sys/vnode.h>
#include <sys/list.h>
#include <sys/stat.h>
...
#define SEM_FILE	"/etc/rfs/.rfadmin"
...
char *argv[];
{
	...
	/*
	 *	At this point, all other options require appropriate
	 *	priviledges.
	 */
...
int   cmd;
{
	char domain[MAXDNAME], name[SYS_NMLN];
	...
	strncpy(name, namepart(host), SYS_NMLN);
	name[SYS_NMLN - 1] = '\0';
 ...
 *	In Enhanced Security, user privileges are validated by the kernel.
 */
