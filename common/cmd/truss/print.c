...
#ident	"@(#)truss:common/cmd/truss/print.c	1.9.7.4"
#ident  "$Header: print.c 1.4 91/07/09 $"
#include <stdio.h>
#include <string.h>
#include <signal.h>
#include <termio.h>
...
extern	void	prt_cxen( int , int );
static 	void	prt_boo(int, int);
static 	void	prt_mdc(int, int);
static 	void	prt_mdt(int, int);
static	void	prt_ihx(int, int);
...
static void
prt_ihx(int val, int raw)
{
	prt_hex(fetchval(val), 0);
}
