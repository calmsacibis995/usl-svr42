...
#ident	"@(#)truss:common/cmd/truss/proto.h	1.6.7.2"
#ident  "$Header: proto.h 1.4 91/07/09 $"
...
extern	unsigned getargp(process_t *, int *);
...
extern	void	dumpargs(process_t *, char *, CONST char *);
...
extern	unsigned getargp();
extern	void	showargs();
extern	void	set_upid();
extern	int	execute();
extern	int	checksyscall();
extern	void	showpaths();
extern	void	dumpargs();
