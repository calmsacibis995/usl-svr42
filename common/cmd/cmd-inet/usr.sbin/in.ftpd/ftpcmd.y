...
%{
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.sbin/in.ftpd/ftpcmd.y	1.5.9.2"
#ident  "$Header: ftpcmd.y 1.2 91/06/26 $"
...
struct tab cmdtab[] = {		/* In order defined in RFC 765 */
	...
	{ "SYST", SYST, ARGS, 0,	"(get type of operating system)" },
