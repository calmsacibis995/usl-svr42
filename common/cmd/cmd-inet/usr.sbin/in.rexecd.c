...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.sbin/in.rexecd.c	1.6.11.2"
#ident  "$Header: in.rexecd.c 1.2 91/06/26 $"
	...
	struct sockaddr_in *fromp;
{
	...
	if (cp)
		...
		cp = pwd->pw_shell;
	CLR_MAXPRIVS_FOR_EXEC execl(pwd->pw_shell, cp, "-c", cmdbuf, (char *)0);
	perror(pwd->pw_shell);
#ifdef AUDIT
