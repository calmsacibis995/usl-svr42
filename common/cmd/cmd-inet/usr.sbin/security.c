...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.sbin/security.c	1.2.1.1"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/cmd-inet/usr.sbin/security.c,v 1.1 91/02/28 16:37:32 ccs Exp $"
