...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.sbin/in.comsat.c	1.7.8.3"
#ident  "$Header: in.comsat.c 1.2 91/06/26 $"
	...
	register struct utmp *utp;
{
	...
	if (CLR_WORKPRIVS_NON_ADMIN(setuid(pwd->pw_uid)) == -1) {
