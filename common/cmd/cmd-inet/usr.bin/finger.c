...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.bin/finger.c	1.8.9.2"
#ident  "$Header: finger.c 1.2 91/06/26 $"
	...
	register char **argv;
{
	...
	while ( (c = getopt(argc, argv, "bfhilmpqsw")) != -1 ) {
		switch(c) {
