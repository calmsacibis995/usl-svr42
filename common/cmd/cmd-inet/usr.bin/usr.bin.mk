...
#ident	"@(#)cmd-inet:common/cmd/cmd-inet/usr.bin/usr.bin.mk	1.17.11.1"
#ident  "$Header: usr.bin.mk 1.5 91/06/26 $"
...
PRODUCTS=	rcp rlogin rsh finger rdate ruptime rwho telnet whois
...
telnet:		telnet.o
		$(CC) -o $@ $(LDFLAGS) telnet.o $(LDLIBS) $(SHLIBS)
