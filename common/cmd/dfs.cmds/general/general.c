...
#ident	"@(#)dfs.cmds:general/general.c	1.1.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/dfs.cmds/general/general.c,v 1.1 91/02/28 16:54:27 ccs Exp $"
