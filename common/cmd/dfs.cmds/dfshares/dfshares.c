...
#ident	"@(#)dfs.cmds:dfshares/dfshares.c	1.3.6.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/dfs.cmds/dfshares/dfshares.c,v 1.1 91/02/28 16:54:23 ccs Exp $"
