...
spellin1: spellin1.o huff1.o
	$(HCC) -o $@ spellin1.o huff1.o $(LDFLAGS) $(LDLIBS) 
...
hashmk1: hashmake1.o hash1.o
	$(HCC) $(CFLAGS) -o $@ hashmake1.o hash1.o $(LDFLAGS) $(LDLIBS)
...
install: all $(DIRS)
	...
	-$(SYMLINK) /usr/share/lib/spell/hstop $(LIBDIR)/hstop
	-$(SYMLINK) /usr/share/lib/spell/hlistb $(LIBDIR)/hlistb
	-$(SYMLINK) /usr/share/lib/spell/hlista $(LIBDIR)/hlista
	-$(SYMLINK) /usr/share/lib/spell/compress $(LIBDIR)/compress
