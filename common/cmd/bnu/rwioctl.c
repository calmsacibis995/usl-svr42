...
#ident	"@(#)bnu:rwioctl.c	1.1.3.3"
#ident "$Header: rwioctl.c 1.1 91/02/28 $"
...
extern int t_close(), t_look(), t_rcvdis(), t_getinfo(), t_getstate(),
	t_alloc(), t_free(), t_rcv(), t_snd(), t_sync(), t_unbind();
#endif /*  TLI  */
