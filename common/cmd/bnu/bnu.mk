...
LDLIBS= $(IFLAG) $(S5LDFLAGS) -lcrypt $(TLILIB)
...
install: copyright $(DIRS) spdirs all shells cp check
...
cp:	all 
	...
	$(INS) $(OLD) -f $(USRBIN) -m 4111 -u $(OWN) -g $(GRP) uugetty
...
uugetty:	$(OUUGETTY)
	$(CC) $(LDFLAGS) $(OUUGETTY) -o $@ $(LDLIBS) -lcmd $(SHLIBS)
