#ident	"@(#)debugger:libcmd/common/Keyword.C	1.6.1.1"
...
//	str		op		opts	arg_type[MAX_ARGS]
	...
	"create",	CREATE,		"dref:2",
		{ OP_COMMAND, OP_OPT|OP_CHARSTAR, 0, 0, 0 },
	"delete",	DELETE,		"ap:2",
	...
	"functions",	FUNCTIONS,	"sf:3o:4",
		{ 0, 0, OP_OPT|OP_FILE,	OP_OPT|OP_FILE, 0 }, 
	"grab",		GRAB,		"c:2l:3f:5",
	...
	"list",		LIST,		"c:2",	{ 0, OP_OPT|OP_NUMBER, OP_LOCATION, 0, 0},
	...
	// gui only
	"ppath",	PPATH,		"p:2",	{ 0, OP_OPT|OP_PROCS, OP_REQ|OP_FILE, 0 },
	"print",	PRINT,		"p:2f:3",
