...
#ident	"@(#)debugger:libedit/common/vi.c	1.1"
/*
...
#   define isalph(v)	(isalnum(virtual[v]) || (virtual[v] == '_'))
...
unsigned nchar;				/* number of chars to read */
{
	...
	if( !is_option(VIRAW) )
	{
		...
		{
			return(debug_read(fd, shbuf, nchar));
		}
