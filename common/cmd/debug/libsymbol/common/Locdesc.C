#ident	"@(#)debugger:libsymbol/common/Locdesc.C	1.3"
...
Place
Locdesc::place( LWP * process, Frame * frame )
{
	Place		lvalue;
...
Place
Locdesc::place( LWP * process, Frame * frame, Iaddr addr )
{
	Place		lvalue;
...
void
Locdesc::calculate_expr( Place & lvalue, LWP * process, Frame * frame )
{
	int		len;
	char *		p;
	PlaceMark	kind;
