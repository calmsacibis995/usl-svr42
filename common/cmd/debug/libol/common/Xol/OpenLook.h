...
#ifndef	NOIDENT
#ident	"@(#)debugger:libol/common/Xol/OpenLook.h	1.2"
#endif
...
#define OlFontWidth(font, font_list) ( OlFontMaxBounds(font, font_list).width )
#else
...
/* this should be used as a returned value of OlLookupImString() in 
   next load
*/
/*  In X11R5 these status symbols are defined in Xlib.h.  */
