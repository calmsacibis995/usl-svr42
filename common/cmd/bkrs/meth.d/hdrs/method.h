...
#ident	"@(#)bkrs:common/cmd/bkrs/meth.d/hdrs/method.h	1.15.5.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/bkrs/meth.d/hdrs/method.h,v 1.1 91/02/28 16:16:50 ccs Exp $"
...
#define UNUSED	0x80000

#define REST_IGNORE ( eflag | pflag | dflag | iflag | lflag | mflag | rflag | tflag | nflag | vflag | Eflag | Nflag | sflag )	/* restore ignores */
