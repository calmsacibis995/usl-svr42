...
#ident	"@(#)rpcsvc:rusers.c	1.4.7.3"
#ident  "$Header: rusers.c 1.3 91/09/20 $"
...
*/ 
/*
 * "rusers.c 1.12 89/06/21 Copyr 1985 Sun Micro";
 */
	...
	struct netconfig *nconf;
{
	...
	if (netdir_getbyaddr(nconf, &hs, raddrp)) {
		/*
		 * netdir routine could not resolve addr 
		 * - just print out uaddr
		 */
	...
	char *name;
{
	...
	/*
	 * save name to allow eliminations of duplicate answers
	 */
