...
#ident	"@(#)cron:common/cmd/cron/cron.mk	1.50"
#ident "$Header: cron.mk 1.5 91/05/22 $"
...
cron:	copylog.o cron.o funcs.o libelm.a
	$(CC) copylog.o cron.o funcs.o libelm.a -o $@ $(LDFLAGS) \
		$(LDLIBS) $(SHLIBS)

crontab:	crontab.o permit.o funcs.o
	$(CC) crontab.o permit.o funcs.o -o $@ $(LDFLAGS) $(LDLIBS) $(SHLIBS)

at:	at.o att1.o att2.o funcs.o permit.o
	$(CC) at.o att1.o att2.o funcs.o permit.o -o $@ $(LDFLAGS) \
		$(LDLIBS) $(SHLIBS)

atq:	atq.o  funcs.o permit.o
	$(CC) atq.o  funcs.o permit.o -o $@ $(LDFLAGS) $(LDLIBS) $(SHLIBS)

atrm:	atrm.o funcs.o permit.o
	$(CC) atrm.o funcs.o permit.o -o $@ $(LDFLAGS) $(LDLIBS) $(SHLIBS)
