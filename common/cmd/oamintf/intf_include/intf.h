...
#ident	"@(#)oamintf:common/cmd/oamintf/intf_include/intf.h	1.6.10.2"
#ident  "$Header: intf.h 2.0 91/07/12 $"
...
#define DIRINFO " x 0755 root sys 1 NULL NULL"	/* directory info for instalf */
