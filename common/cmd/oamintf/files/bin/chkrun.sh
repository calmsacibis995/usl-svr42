...
#ident	"@(#)filemgmt:common/cmd/oamintf/files/bin/chkrun.sh	1.3.3.1"
#ident	"$Header: $"
...
arg1=${1}
fstype=${2}
bdrv=`/usr/bin/devattr ${arg1} bdevice`
cdrv=`/usr/bin/devattr ${arg1} cdevice`
pdrv=`/usr/bin/devattr ${arg1} pathname`
...
$TFADMIN /sbin/fsck -F ${fstype} ${ddrive}
exit=$?
trap 'exit 0' 2
