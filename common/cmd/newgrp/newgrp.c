...
#ident	"@(#)newgrp:newgrp.c	1.10.1.6"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/newgrp/newgrp.c,v 1.1 91/02/28 18:41:09 ccs Exp $"
...
char *argv[];
{
	...
	/* If this is not a privileged ID system, then the privileges
	   should be cleared so that they are not passed to the new shell */
