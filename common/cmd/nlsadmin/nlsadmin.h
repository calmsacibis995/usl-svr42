...
#ident	"@(#)nlsadmin:nlsadmin.h	1.15.7.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/nlsadmin/nlsadmin.h,v 1.1 91/02/28 18:41:29 ccs Exp $"

/*
 * nlsadmin.h:  nlsadmin defines and structs
 */

#define VERSION		5		/* current database version */
#define MAXNAMESZ	15
