...
#ident	"@(#)mail:common/cmd/mail/re/eg.c	1.2.2.2"
#ident "@(#)eg.c	1.5 'attmail mail(1) command'"
#include	<string.h>
#include	<libc.h>
#include	<setjmp.h>
#include	"re.h"
...
re_re *
egprep(parser, b, e, map, dotstar)
	enum Parsetype parser;
	unsigned char *b;
	unsigned char *e;
	unsigned char *map;
	int dotstar;
