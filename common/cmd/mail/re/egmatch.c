...
#ident	"@(#)mail:common/cmd/mail/re/egmatch.c	1.1"
#ident "@(#)egmatch.c	1.2 'attmail mail(1) command'"
#include	<libc.h>
#include	"re.h"
#include	"lre.h"
...
#else
static unsigned char *eg_slowmatch();
#endif
...
#else
static void undobr();	/* undo group assignements */
#endif

eg_match(r, b, e, rb, re)
	register re_re *r;
