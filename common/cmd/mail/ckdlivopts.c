...
#ident	"@(#)mail:common/cmd/mail/ckdlivopts.c	1.8.2.3"
#ident "@(#)ckdlivopts.c	2.14 'attmail mail(1) command'"
#include "mail.h"
/*
    NAME
	...
	The options discovered in the header are stored into pmsg->delivopts.
 */
...
Msg	*pmsg;
{
	static const char pn[] = "ckdlivopts";
	Hdrs	*hp;
