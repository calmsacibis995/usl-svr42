...
#ident	"@(#)mail:common/cmd/mail/smtp/src/regexec.c	1.4.2.2"
#ident "@(#)regexec.c	1.4 'attmail mail(1) command'"
#ifdef SVR4
#include <stdlib.h>
#endif
#include "regprog.h"
...
restart:
	...
	if (list[0] == NULL) {
		...
		if (list[0] == NULL)
			regerror(":62:regerror: list overflow\n");
	}
