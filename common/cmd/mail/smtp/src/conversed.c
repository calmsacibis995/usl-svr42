...
#ident	"@(#)mail:common/cmd/mail/smtp/src/conversed.c	1.8.2.2"
#ident "@(#)conversed.c	1.9 'attmail mail(1) command'"
 ...
 */
void converse(fi, fo, accept_call)
FILE *fi, *fo;
int accept_call;
{
...
#define	_NFILE 20
	...
	(void) dup(0);
	if(!norun)
		smtpsched("Dsmtpsched", spoolsubdir, 0);
