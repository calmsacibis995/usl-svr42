...
#ident	"@(#)mail:common/cmd/mail/smtp/src/from822.c	1.6.2.2"
#ident "@(#)from822.c	1.6 'attmail mail(1) command'"
#include <stdio.h>
#include <ctype.h>
#include "xmail.h"
#include "s_string.h"
 ...
 */
void from822(net, fgetsp, fi, fo, defsender)
	char *net;
	char *(*fgetsp)();
	FILE *fi;		/* input file */
	FILE *fo;		/* output file */
