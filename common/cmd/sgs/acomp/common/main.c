...
#ident	"@(#)acomp:common/main.c	55.1.3.15"
/* main.c */
...
int dont_fix_bug_flag = 0;		/*
					** Flag to deactivate bug fixes.
					*/
...
#ifndef LINT
#define	COMP_ARGS "1:2:G:OF:X:L:Vad:bf:i:o:vpQ:R:Z:"
#else
#define	COMP_ARGS "1:2:G:OX:L:Vad:f:i:o:vpQ:R:Z:"
#endif
