...
#ident	"@(#)acomp:common/sharp.c	52.22"
/* sharp.c */
...
err:;
    WERROR("ignoring malformed #pragma strict_ieeefp(mode)");
    return;
}
#endif
...
*/
{
	...
	return;
        ...
        WERROR("%s must be declared function", s1);

badprag:
    WERROR("ignoring malformed #pragma asm ");
    return;
}
#endif	/* ASM_PRAGMA */
