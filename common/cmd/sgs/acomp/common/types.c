...
#ident	"@(#)acomp:common/types.c	52.53"
/* types.c */
	...
	*/
	if ((specl & ~(TY_THIDDEN|TY_TMQUAL)) != (specr & ~(TY_THIDDEN|TY_TMQUAL))) {
	    ...
	    */
	    ...
	    /* If either type is non-integral, fail. */
	    ...
	    /* Qualifiers must match at this point */

	    if ( (specl&TY_TQUAL) != (specr&TY_TQUAL) )
	        return( 0 );
