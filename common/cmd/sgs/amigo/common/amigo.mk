...
#ident	"@(#)amigo:common/amigo.mk	1.24"

include $(CMDRULES)
#following two must be set externally
CG_INCS=
CG_MDP=
AC_MDP=
...
PASSLINT = O=ln AC_MDP=$(AC_MDP) CG_INCS="$(CG_INCS)" COMDIR=$(COMDIR) \
	...
	FP_EMULATE=$(FP_EMULATE) CG_MDP=$(CG_MDP)
...
OBJECTS= bitvector.o blocks.o code_mo.o const.o copy_prop.o costing.o \
	...
	loops.o l_unroll.o reg_alloc.o scopes.o str_red.o util.o
...
SRC= $(COMDIR)/bitvector.c \
	...
	$(COMDIR)/l_unroll.c $(COMDIR)/reg_alloc.c $(COMDIR)/scopes.c \
	$(COMDIR)/str_red.c $(COMDIR)/util.c
...
l_unroll.$O:	$(COMDIR)/l_unroll.c $(COMDIR)/l_unroll.h
...
str_red.$O:	$(COMDIR)/str_red.c  $(MDDIR)/costing.h
