...
#ident	"@(#)sgs-inc:common/link.h	1.11"
...
struct link_map {
	...
	unsigned long l_tstart;	/* vaddr of first readonly-executable segment */
	unsigned long l_tsize;	/* size of first readonly-executable segment */
};
