...
void
dump_exec_header(elf_file, nseg, filename, machine)
Elf      *elf_file;
unsigned nseg;
char     *filename;
int	machine;
...
#define Printf	(void)printf
				...
				case PT_88K_DEBINFADDR: 
					if(machine == EM_88K)
						Printf("%-12s", "DEBINFADDR"); break;
					/*
					** Tricky in all other cases fall through
					*/
				default:
