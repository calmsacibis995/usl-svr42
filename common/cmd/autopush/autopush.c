...
#ident	"@(#)autopush:common/cmd/autopush/autopush.c	1.8.4.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/autopush/autopush.c,v 1.1 91/02/28 15:57:59 ccs Exp $"
