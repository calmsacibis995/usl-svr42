...
#ident	"@(#)cpio:common/cmd/cpio/cpio.h	1.3.12.12"
#ident  "$Header: cpio.h 1.3 91/08/27 $"
...
#define ERR	1	/* Error message - no exit */
#define EXT	2	/* Error message - fatal - exit with error count */
#define ERRN	3	/* Error message with errno - no exit */
#define EXTN	4	/* Error message with errno - fatal - exit with error count*/
