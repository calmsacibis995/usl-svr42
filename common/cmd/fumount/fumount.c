...
#ident	"@(#)fumount:fumount.c	1.9.12.3"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/fumount/fumount.c,v 1.1 91/02/28 17:31:25 ccs Exp $"
	...
	char **argv;
{
	...
	/* this stage just for validation */
	/* arguments are re-examined below */
