...
#ident	"@(#)mailx:hdr/def.h	1.7.2.10"
#ident "@(#)def.h	1.26 'attmail mail(1) command'"
...
#define	H_ENCDTYPE	23		/* "Encoding-Type:"	  */
#define	H_DAFWDFROM	24		/* Hold A-F-F when sending Del. Notf. */
#define	H_DTCOPY	25		/* Hold ">To:" when sending Del. Notf.*/
#define	H_DRECEIVED	26		/* Hold Rcvd: when sending Del. Notf.*/
#define H_CONT		27		/* Continuation of previous line */
#define H_NAMEVALUE	28		/* unrecognized "name: value" hdr line*/
...
#define	GMASK	(GTO|GCC|GBCC|GDEFOPT|GENCTYP|GSUBJECT|GOTHER|GCLEN|GNL)
...
extern void		alter ARGS((char*));
extern int		alternates ARGS((char**));
extern void		announce ARGS((void));
extern int		any ARGS((int,char*));
extern int		anyof ARGS((char*,char*));
extern int		argcount ARGS((char**));
extern void		assign ARGS((char*,char*));
extern int		beditor ARGS((int*));
extern int		blankline ARGS((char*));
...
extern char		*copy ARGS((char*,char*));
...
extern int		getmsglist ARGS((char*,int*,int));
...
extern int		puthead ARGS((struct header*,FILE*,int,FILE*));
...
extern int		removefile ARGS((char*));
...
extern char		*safeexpand ARGS((char*));
extern VOID		*salloc ARGS((unsigned));
extern int		Save ARGS((int*));
extern int		savemail ARGS((char*,int,struct header*,FILE*,off_t,int));
...
extern char		*savestr ARGS((char*));
extern int		schdir ARGS((char*));
extern int		scroll ARGS((char*));
extern long		send ARGS((struct message*,FILE*,int,int,int));
extern int		sendm ARGS((char*));
extern int		Sendm ARGS((char*));
extern int		sendmail ARGS((char*));
extern int		Sendmail ARGS((char*));
extern int		set ARGS((char**));
extern int		setfile ARGS((char*,int));
extern FILE		*setinput ARGS((struct message*));
extern void		setptr ARGS((FILE*));
extern int		shell ARGS((char*));
extern int		showheaders ARGS((char[]));
extern void		sigchild ARGS((void));
extern void		(*sigset ARGS((int i, void(*f)(int))))();
extern char		*skin ARGS((char*));
extern char		*snarf2 ARGS((char*,int*));
extern int		source ARGS((char*));
...
extern char		*value ARGS((char*));
extern char		*vcopy ARGS((char*));
