...
#ident	"@(#)mailx:tty.c	1.10.2.5"
#ident "@(#)tty.c	1.14 'attmail mail(1) command'"
...
static	int	c_intr;			/* Current interrupt char */
static	int	c_quit;			/* Current quit character */
static	int	c_word;			/* Current word erase char */
static	int	c_eof;			/* Current eof char */
