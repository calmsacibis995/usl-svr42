...
#ident	"@(#)write:write.c	1.19.1.9"
#ident "$Header: write.c 1.2 91/08/08 $"
...
/* permit: check mode of terminal - if not writable by all disallow writing to (even the user him/herself cannot therefore write to their own tty) */
