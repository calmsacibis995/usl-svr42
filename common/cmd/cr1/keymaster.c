...
#ident	"@(#)cr1:keymaster.c	1.4.2.3"
#ident  "$Header: keymaster.c 1.2 91/06/25 $"
...
main (int argc, char *argv[])
{
	...
	if ( (ret = key_lock(scheme)) != -1) {
		...
		while ( (ret = send_msg(scheme, &smsg)) != 0 ) {
