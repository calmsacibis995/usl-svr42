#ident	"@(#)ucb:common/ucbcmd/troff/ni.c	1.2"
#ident	"$Header: $"
...
char	termtab[NS] = "/usr/ucblib/doctools/nterm/tab.";  /* term type added in ptinit() */
char	fontfile[NS] = "";	/* not used */
char	devname[20] = "37";

#else

char	termtab[NS] = "/usr/ucblib/doctools/font"; /* rest added in ptinit() */
char	fontfile[NS] = "/usr/ucblib/doctools/font";/* rest added in casefp() */
char	devname[20]	 = "aps";	/* default typesetter */
...
int	pfrom = 1;
int	print = 1;
char	nextf[NS] = "/usr/ucblib/doctools/tmac/";
char	mfiles[NMF][NS];
int	nmfi = 0;
#ifndef NROFF
int	oldbits = -1;
