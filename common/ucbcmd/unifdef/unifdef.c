#ident	"@(#)ucb:common/ucbcmd/unifdef/unifdef.c	1.2"
#ident	"$Header: $"
...
short insym[MAXSYMS] BSS; /*defined as short to work with -1 on all machines*/
#define KWSIZE 8
char buf[KWSIZE];
char nsyms BSS;
char incomment BSS;
...
int reject BSS;    /* 0 or 1: pass thru; 1 or 2: ignore comments */
