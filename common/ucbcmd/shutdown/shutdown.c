#ident	"@(#)ucb:common/ucbcmd/shutdown/shutdown.c	1.4"
#ident	"$Header: $"
	...
	char **argv;
{
	...
	(void) signal(SIGQUIT, finish_sig);
	...
	int first;
{
	...
	if (*mesg)	/* print out the command line warning message */
