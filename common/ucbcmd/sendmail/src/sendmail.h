#ident	"@(#)ucb:common/ucbcmd/sendmail/src/sendmail.h	1.2"
#ident	"$Header: $"
...
struct mxinfo
{
	...
	int	mx_rcode;			/* remembered error code */
	char 	*mx_hosts[MAXMXHOSTS+1];	/* names of exchangers */
};

/*
 * Cache entry for YP lookup operations
 */
struct bitmap2
{
...
# endif HOSTINFO
		struct bitmap2	sv_bitmap2;	/* YP lookup cache */
	}	s_value;
};
