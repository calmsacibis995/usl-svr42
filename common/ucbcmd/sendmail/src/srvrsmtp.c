#ident	"@(#)ucb:common/ucbcmd/sendmail/src/srvrsmtp.c	1.2"
#ident	"$Header: $"
...
# ifndef SMTP
SCCSID(@(#)srvrsmtp.c 1.29 88/12/10 SMI (no SMTP)); /* from UCB 5.18 1/5/86/28/85 */
# else SMTP

SCCSID(@(#)srvrsmtp.c 1.29 88/12/10 SMI); /* from UCB 5.18 1/5/86/28/85 */
