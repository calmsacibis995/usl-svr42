#ident	"@(#)ucb:common/ucbcmd/sendmail/src/conf.c	1.3"
#ident	"$Header: $"
...
SCCSID(conf.c 1.20 88/02/08 SMI); /* from UCB 5.14 1/10/86 */
...
char	*ConfFile =	"/usr/ucblib/sendmail.cf";	/* runtime configuration */
char	*ConfFile2 =	"/usr/ucblib/sendmail.cf";	/* Alternate configuration */
char	*FreezeFile =	"/usr/ucblib/sendmail.fc";	/* frozen version of above */
