#ident	"@(#)ucb:common/ucbcmd/sendmail/src/util.c	1.2"
#ident	"$Header: $"
...
SCCSID(@(#)util.c 1.17 88/05/09 SMI); /* from UCB 5.8 12/17/85 */
...
#ifdef INTER
/*
**  PUTLINE_8BIT -- put a line like fputs obeying SMTP conventions
**
**	This routine always guarantees outputing a newline (or CRLF,
**	as appropriate) at the end of the string.
**
**	This routine is almost a copy of putline, but this one does
**	not strip off the 8th bit. This routine will be used in
**	putbody() routine.
**
**	Parameters:
**		l -- line to put.
