    ...
    char  *argv[];
{
    ...
    */
	 ...
	 *	CHANGE # UNKNOWN
	 *	FILE # BitEdit.c
	 * 	Cleaned up the argument handling. Removed a bug which caused 
	 *	WM_DELETE_WINDOW not to be supported if a filename was not specified.
	 *	ENDCHANGE # UNKNOWN
	 */
    if (argc == 2)
    {
	    BWReadFile(bitmap_widget, argv[1], NULL);
    }
    else if (argc > 2)
    {
	    /*
