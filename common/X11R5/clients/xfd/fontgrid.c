 ...
 *	CHANGE # UNKNOWN
 *	FILE # fontgrid.c
 *  Grid width was not considered while selecting the character, due to
 *	which last row and last column characters could not be selected.
 *	ENDCHANGE # UNKNOWN
 */
