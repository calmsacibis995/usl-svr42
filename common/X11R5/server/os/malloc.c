...
#ident	"@(#)siserver:os/malloc.c	1.1"
...
#define FREESIZE	100 /* size for preserving free blocks until next malloc */

static VOID	*flist[FREESIZE+1]; /* list of blocks to be freed on next malloc */
