...
#ident	"@(#)siserver:dix/extension.c	1.1"
...
#ifndef i386	/* funNotUsedByATT, AddExtensionAlias */
    ...
    ClientPtr client;
{
    ...
    if (major >= (unsigned) NumExtensions)
	return 0;
...
#ifndef i386	/* funNotUsedByATT, LookupProc, RegisterProc, RegisterScreenProc */
