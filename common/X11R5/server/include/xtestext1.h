...
#ident	"@(#)siserver:include/xtestext1.h	1.3"
...
/*
** Added by AT&T 2/14/89
*/
#define X_TestStartSimulation            6
#define X_TestStopSimulation             7
...
#define sz_xTestFakeInputReq		72
...
#define XTestUnpackDeviceID(x)	(((unsigned) ((x) & XTestDEVICE_ID_MASK)) >> 4)
...
#define XTestUnpackYMotionValue(x) (((unsigned) ((x) & XTestY_MOTION_MASK)) \
				    >> 4)
