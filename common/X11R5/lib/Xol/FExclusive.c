...
#ifndef	NOIDENT
#ident	"@(#)flat:FExclusive.c	1.58"
#endif

/******************************file*header********************************

    Description:
	This file contains the source code for the flat exclusive container.
*/
						/* #includes go here	*/
...
static XtResource resources[] = {
	...
	/* Note that XtNnoneSet is False by default in flatButtons	*/
  {
	...
	OFFSET(buttons.exclusive_settings), XtRImmediate,(XtPointer)True
  },
};
#undef OFFSET
...
flatExclusivesClassRec = {
	...
	(XtPointer)NULL,			/* extension		*/
	True,					/* transparent_bg	*/
	XtOffsetOf(FlatExclusivesRec, default_item),/* default_offset	*/
...
ClassInitialize OL_NO_ARGS()
{
    ...
    */
	OlFlatInheritAll(flatExclusivesWidgetClass);
