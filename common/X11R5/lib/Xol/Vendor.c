...
#ifndef	NOIDENT
#ident	"@(#)mouseless:Vendor.c	1.104"
#endif
...
static void
Debug__DumpGeometry (XtWidgetGeometry *	g) {
  ...
  {						/* core class		*/
	...
	_OlDefaultQueryGeometry,		/* query_geometry	*/
  	NULL,					/* display_accelerator  */
    	&layoutCoreClassExtension  		/* extension		*/
  },
  {						/* composite class	*/
    ...
    OLGRA(XtWidgetGeometry *,      	geometry)
{
    ...
    status_area.width = geometry->width;
