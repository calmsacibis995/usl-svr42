...
#ifndef NOIDENT
#ident	"@(#)primitive:Primitive.c	1.76"
#endif
...
/*
 * take this out, nobody knows why it was here in the first place and it's
 * breaking the Motif focus-border color
 *
  { { XtNborderColor, XtCBorderColor, XtRPixel, sizeof(Pixel), 0,
      XtRString, XtDefaultForeground }, BYTE_OFFSET, OL_B_PRIMITIVE_BORDERCOLOR, NULL },
 */
};
#undef BYTE_OFFSET
