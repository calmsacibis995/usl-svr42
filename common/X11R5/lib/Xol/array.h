...
/*************************************************************************
 *
 * Description:	OpenLook interface to a generic array
 *
 ...
 */
typedef int (*_OlArrayQsortArg4) OL_ARGS((const void * , const void *));

typedef int (*_OlArrayCompareFncType) OL_ARGS(( char * , char * ));
...
extern int
_OlArrayDefaultCompare OL_ARGS((
	char *			pA,
	char *			pB
));
extern int
___OlArrayInsert OL_ARGS((
	char *			file,
	int			line,
	CharArray *		pVar,
	int			flag,
...
extern int
__OlWidgetArrayFindByName OL_ARGS((
	char *			file,
	int			line,
	WidgetArray *		pVar,
	String			name
