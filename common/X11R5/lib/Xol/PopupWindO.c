...
#ident	"@(#)popupwindo:PopupWindO.c	1.13"

/****************************************************************************
 *
 *	PopupWindO.c:
 *		OPEN LOOK (tm) -mode GUI-specific code for PopupWindowShell
 *
 *
 ****************************************************************************/
	...
	OLGRA( XtPointer,	call_data)
{
	...
	switch (which)
		...
		case APPLY_ITEM:
			...
			_OlPWBringDownPopup(parent, False);
			break;
