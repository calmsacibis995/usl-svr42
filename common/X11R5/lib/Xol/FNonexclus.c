...
#ifndef	NOIDENT
#ident	"@(#)flat:FNonexclus.c	1.19"
#endif

/******************************file*header********************************

    Description:
	This file contains the source code for the flat non-exclusive
	containers.
...
#define OFFSET(f)	XtOffsetOf(FlatNonexclusivesRec, f)
...
static XtResource resources[] = {
	...
	/*	in flatButtons...					*/
  {
	...
	OFFSET(buttons.button_type), XtRImmediate, (XtPointer)OL_RECT_BTN
  },
};
#undef OFFSET
...
flatNonexclusivesClassRec = {
	...
	(XtPointer)NULL,			/* extension		*/
	True,					/* transparent_bg	*/
	XtOffsetOf(FlatNonexclusivesRec, default_item),/* default_offset*/
	sizeof(FlatNonexclusivesItemRec)	/* rec_size		*/
...
ClassInitialize OL_NO_ARGS()
{
    ...
    */
	OlFlatInheritAll(flatNonexclusivesWidgetClass);
