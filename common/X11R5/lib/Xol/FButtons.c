 ...
 */
static void
FBMenuSetToCurrent OLARGLIST((w, fexcp, old_current, current_item, reset, x, y, motion_or_enter, is_menu_cmd))
  OLARG( Widget,		w)
  OLARG( FlatButtonsPart *,	fexcp)
  OLARG( Cardinal,		old_current)
