...
/*
 * 18 March 1992 USL/WIPRO
 * 	We should check for unrealized windows when we enter 'set_shape()'.
 *	we should not create a pixmap on an unrealized window. This bug came
 *	on a commandline -shape -geometry 200x200 which caused SetValues to be
 *	called before the widget was realized.
 */
