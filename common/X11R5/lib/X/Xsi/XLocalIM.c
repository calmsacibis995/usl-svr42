...
#ident	"@(#)R5Xlib:Xsi/XLocalIM.c	1.4"
    ...
    XPointer client_data;
{
	...
	for (i = 0; i < xcvt->buf_cnt; i++) {
        ...
        /* kludge to cater for situations when
           a keysym can be generated by more than
           one key and XKeysymToKeycode() can return
           wrong keycode. Kludge tested for 
           Latin-1, not for others; see MR # uv92-20206  */
