...
#ifndef NOIDENT
#pragma ident	"@(#)Gizmo:NumericGiz.c	1.18"
#endif
...
ManipulateNumericGizmo(NumericGizmo * gizmo, ManipulateOption option)
{
   ...
   case SetGizmoValue:
      gizmo->settings->previous_value = gizmo->settings->current_value;
      fprintf(stderr, "save to xdefaults!!!\n");
/*
 * FIX and write to Xdefaults
 */
      break;
...
#define XtRNumericGizmo "NumericGizmo"
      break;
   default:
      break;
   }
