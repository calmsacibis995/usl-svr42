...
#ifndef NOIDENT
#pragma ident	"@(#)Gizmo:MenuGizmo.h	1.16"
#endif
 ...
 * Menu
 *
 * The \fIMenuGizmo\fP is used to construct, optionally tiered, menu
 * interface elements.  The \fIMenu\fP Gizmo is a comprized of two
 * data structures: a List of \fIMenuItems\fP used to describe the
 * per-item information for the MenuButtons (and is used as the XtNitems
 * resource of the FlatButtons Widget in the PopupShell) and the \fIMenu\fP
