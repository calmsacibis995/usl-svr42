...
#ident	"@(#)libfolio1.2:include/frmath.h	1.1"
/*
**    +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
**   
...
extern	short	fr_overflows;	/* overflow occured flag */

extern fract	frmul(), frdiv(), frsqrt();
extern fract	frsind(), frcosd(), fratan2();
extern fract	frarccosd(), frhypotenuse();
...
#define fracti(i)	((fract)((i)*(((int32)1)<<16)))
#define floatfr(x)	(((float) x)/(((int32)1)<<16))
#define	fractf(x)	(fract) ((x)*(((int32)1)<<16))

#define FRHUGE		((fract)0x7fffffff)
#define	FRHUGENEG	((fract)0x80000000)
#define FRHALF		((fract)0x00008000) /* exactly 0.5 */
#define	FRONE		((fract)0x00010000)
#define FRZERO		((fract)0)
#define	FRALMOST1	((fract)0x0000ffff)
...
#define	fract_overflows	fr_overflows
