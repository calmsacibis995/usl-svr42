...
#ident	"@(#)r5fontutil:clients/mkfontscale/mkfontscale.c	1.9"
...
static Boolean
FontFileMatchRenderer( String file_name)
{
...
static Boolean
GetXLFD( String dir_name, String file_name)
{
    char full_name[MAX_PATH_STRING];
    FILE *file;
    int i;
    ...
    char	*dir_name;
{
	...
	if (FontFileMatchRenderer (direntp->d_name))
	    GetXLFD( dir_name, direntp->d_name);
    }
    closedir(dirp);
