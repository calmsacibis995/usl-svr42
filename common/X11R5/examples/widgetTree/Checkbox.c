...
#ifndef NOIDENT
#ident	"@(#)widgetTree:Checkbox.c	1.1"
#endif

/*  Example of the Checkbox widget.  */
...
/*ARGSUSED*/
void
CheckboxCB OLARGLIST((w, client_data,  call_data))
        OLARG(Widget, w)
        ...
        OLGRA(XtPointer, call_data)
{
	...
	XtAddCallback(popup, XtNpopdownCallback, DestroyCB, w);
        ...
        XtVaCreateManagedWidget("checkbox", checkBoxWidgetClass, upper,
                XtNlabel, "Checkbox:",
