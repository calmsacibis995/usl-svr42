...
#ifndef NOIDENT
#ident	"@(#)widgetTree:Slider.c	1.1"
#endif

/*  Example of the Slider widget.  */
...
/*ARGSUSED*/
void
SliderCB OLARGLIST((w, client_data,  call_data))
        OLARG(Widget, w)
        ...
        OLGRA(XtPointer, call_data)
{
	...
	XtAddCallback(popup, XtNpopdownCallback, DestroyCB, w);
        ...
        XtVaCreateManagedWidget("slider", sliderWidgetClass, caption,
		XtNspan, 100,
		XtNsliderValue, 33,
		XtNminLabel, "0",
		XtNmaxLabel, "100",
