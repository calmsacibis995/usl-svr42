...
#ifndef	NOIDENT
#ident	"@(#)olexamples:text/unittest10.c	1.4"
#endif

/*
 *  OLXTK-32.24 - test that the XtNtopMargin resource works
...
static char string1[] = "This is a text widget. \
 This test is setting XtNtopMargin to 20.";

static char string2[] = "This is a text widget. \
 This test is setting XtNtopMargin to 0.";

static char string3[] = "This is a text widget. \
 This test is setting XtNtopMargin to -1.";
...
char **argv;
{
	...
	XtSetArg(arg[n], XtNtopMargin, 20);			n++;
	...
	XtSetArg(arg[n], XtNtopMargin, 0);			n++;
	XtSetArg(arg[n], XtNwidth, 200);			n++;
	editText = XtCreateManagedWidget("Text",
		textWidgetClass,
		box,
	...
	XtSetArg(arg[n], XtNtopMargin, -1);			n++;
	XtSetArg(arg[n], XtNwidth, 200);			n++;
	editText = XtCreateManagedWidget("Text",
		textWidgetClass,
		box,
