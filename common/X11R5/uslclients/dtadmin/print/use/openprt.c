...
#ifndef NOIDENT
#ident	"@(#)dtadmin:print/use/openprt.c	1.13"
#endif
...
static Widget	BuildIconBox (Widget parent, Printer *printer);
...
MakeBaseWindow (Printer *printer)
{
    ...
    printer->iconbox = BuildIconBox (form, printer);
 ...
 */
static Widget
BuildIconBox (Widget parent, Printer *printer)
{
    IconItem		*items;
    int			itemCnt;
    Widget		scrolledWin;
