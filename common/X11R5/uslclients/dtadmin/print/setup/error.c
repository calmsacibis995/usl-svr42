...
#ifndef NOIDENT
#ident	"@(#)dtadmin:print/setup/error.c	1.10"
#endif
 ...
 */
void
Error (Widget widget, char *errorMsg, int noticeType)
{
    ErrorConfirm (widget, errorMsg, noticeType, 0, 0);
} /* End of Error () */
 ...
 */
void
ErrorConfirm (Widget widget, char *errorMsg, int noticeType,
	      XtCallbackProc callback, XtPointer closure)
{
    ...
    notice = XtVaCreatePopupShell ("Message", modalShellWidgetClass, widget,
		XtNnoticeType,		(XtArgVal) noticeType,
