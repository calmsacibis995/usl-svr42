...
#ifndef NOIDENT
#pragma ident	"@(#)dtadmin:nfs/remoteProp.h	1.24"
#endif
...
static MenuGizmo getHostMenu = { NULL, "_X_", "_X_", getHostItems,
				    getHostCB };
static ChoiceGizmo getHostChoice = {NULL, "_X_", "",  &getHostMenu};
...
static MenuGizmo getListMenu = { NULL, "_X_", "_X_", getListItems,
				    GetAvailableList };
static ChoiceGizmo getListChoice = {NULL, "_X_", "",  &getListMenu};
...
static MenuGizmo findFolderMenu = { NULL, "_X_", "_X_", findFolderItems,
				    findFolderCB };
static ChoiceGizmo findFolderChoice = {NULL, "_X_", "",  &findFolderMenu};
