...
#ifndef	NOIDENT
#ident	"@(#)dtadmin:dialup/modem.c	1.16"
#endif
...
DeviceItems families[] = {
	{ label_hayes, "hayes" },
	{ label_hayesSM1200, "HayesSmartm1200" },
	{ label_hayesSM2400, "HayesSmartm2400" },
	{ label_att4000, "att4000" },
	{ label_att4024, "att4024" },
	{ label_att2224, "att2224" },
	{ label_att2248, "att2248a" },
	{ label_att2296, "att2296a" },
	{ label_tb, "tb" },
	{ label_multitech, "Multinormalv29" },
	{ label_datakit, "datakit" },
	{ label_direct, "direct" },
};
...
caddr_t	param;
{
	...
	static DeviceItems	*current, *ItemPtr;
	static unsigned		numberOfItem;
	static Boolean		first_time = True;

	if (first_time) {
		first_time = False;
		ReadModemTable(&ItemPtr, &numberOfItem);
		current = ItemPtr;
	}
	...
	case SET: {
		...
		pItem = FindModem(value, families, NR_FAMILIES, &index);
		if (pItem != NULL) {
			OlVaFlatSetValues(
				df->w_modem,
