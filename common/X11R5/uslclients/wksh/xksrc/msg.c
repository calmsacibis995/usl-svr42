...
#ident	"@(#)wksh:xksrc/msg.c	1.1"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/ksh/sh/msg.c,v 1.1 91/02/28 17:41:13 ccs Exp $"
...
#ifdef MULTIBYTE
#include	"national.h"
    MSG e_version = "\n@(#)Version M-11/16/88g-beta3\0\n";
#else
    MSG e_version = "\n@(#)Version 11/16/88g-beta3\0\n";
#endif /* MULTIBYTE */
