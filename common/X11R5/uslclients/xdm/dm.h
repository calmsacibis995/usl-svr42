...
#define	PASSWD_NEEDED	2
#define	PASSWD_AGED	3
#define	PASSWD_EXPIRED	4
#define	ACCOUNT_EXPIRED	5
#define	PW_MAXTRYS	3

#define	TOO_SHORT	10
#define	CIRC		11
#define	SPECIAL_CHARS	12
#define	DF3CHARS	13
...
struct display {
	...
	int		thrashThreshold;/* time within X may start and die */
	int		trashThreshold; /* # of tries X may start and die */
	...
	int		showIcons;	/* display icons in login window */
	int		showRootIcon;	/* display root icon in login window */
	...
	char		*linkPath;	/* dynamic link path */
...
# define USE_XTERM		7	/* give the user an xterm */
