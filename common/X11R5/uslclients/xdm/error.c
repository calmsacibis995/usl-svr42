 ...
 *	FILE # error.c
 *
 *  stderr has to be closed before dup'ing. Error log is setup before
 *  the process becomes a daemon so that it is not necessary to dup
 *  the standard file descriptors to the root inode (as originally 
 *  done in daemon.c
 *
 *	ENDCHANGE # UNKNOWN
 */
