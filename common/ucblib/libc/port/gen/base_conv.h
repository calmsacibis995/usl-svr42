...
#ident	"@(#)ucb:common/ucblib/libc/port/gen/base_conv.h	1.1"
#ident	"$Header: $"
...
#define BIG_FLOAT_TIMES_NOMEM	0	/* used to be casted to (_big_float) */
#define BIG_FLOAT_TIMES_TOOBIG	1
