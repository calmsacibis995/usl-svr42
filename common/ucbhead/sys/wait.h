...
#ident	"@(#)ucb:common/ucbhead/sys/wait.h	1.2"
#ident	"$Header: $"
...
#ifndef UCB_SYS_WAIT_H
#define UCB_SYS_WAIT_H
/*
...
#define WLOBYTE(stat)		((int)((stat.w_status)&0377))
#define WHIBYTE(stat)		((int)(((stat.w_status)>>8)&0377))
#define WWORD(stat)		((int)((stat.w_status))&0177777)
...
#define WCOREDUMP(stat)		((stat.w_status)&WCOREFLG)
