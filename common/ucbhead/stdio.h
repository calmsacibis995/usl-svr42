...
#ident	"@(#)ucb:common/ucbhead/stdio.h	1.1"
#ident	"$Header: $"
/*******************************************************************
...
/* PRINTFLIKE2 */
extern const char	*sprintf(const char *, const char *, ...);
/* SCANFLIKE2 */
extern int	sscanf(const char *, const char *, ...);
extern int	vfprintf(FILE *, const char *, void *);
extern int	vprintf(const char *, void *);
extern char	*vsprintf(char *, char *, void *);
...
extern int      fclose(), fflush(), fread(), fwrite(), fseek(), fgetc(),
                getw(), pclose(), printf(), fprintf(), vprintf(), vfprintf(),
		fputc(), putw(), puts(), fputs(), scanf(), fscanf(), sscanf(),
