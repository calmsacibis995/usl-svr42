...
#ident	"@(#)libgenIO:i386/lib/libgenIO/g_write.c	1.1.4.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/lib/libgenIO/g_write.c,v 1.1 91/02/28 20:45:46 ccs Exp $"
