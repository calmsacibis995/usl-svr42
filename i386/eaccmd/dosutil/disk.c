...
#ident	"@(#)eac:i386/eaccmd/dosutil/disk.c	1.1.1.3"
#ident  "$Header: disk.c 1.1 91/07/03 $"
...
static char sectbuf[BPS];		/* buffer for reading sectors */
...
int oflag;
{
	 ...
	 * assume the 1st digit in the last component
	 *   of dev is the drive no;
	 * if there is no digit, assume drive 0.
	 */
	if ((drive = strpbrk(base, "0123456789")) == NULL)
		drive = "0";
