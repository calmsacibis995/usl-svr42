...
#if __i386
extern fpclass_t fpclassl(long double);	/* get class of long double value */
...
#if __i386
extern fpclass_t fpclassl();	/* get class of long double value */
#endif
#endif
...
extern void _s2dec(const float *, decimal *, int);
extern void _d2dec(const double *, decimal *, int);
