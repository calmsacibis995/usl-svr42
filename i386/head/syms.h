...
#define	SYMESZ	sizeof(SYMENT)	/* was 18 */

#define	AUXENT	union auxent
#define	AUXESZ	sizeof(AUXENT)	/* was 18 */
...
#if m88k
/* XXX_INTERIM
 * The new BCS doesn't have leading underscores!  Change this when
 * we get a coff compiler that doesn't generate them.
 */
