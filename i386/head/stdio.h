...
#ifdef __STDC__
#if #machine(i386) || #machine(i860)
#define _NFILE	60	/* initial number of streams */
#elif #machine(m88k)
#define _NFILE	64	/* initial number of streams */
#else
...
#endif	/* i386 or i860	*/
#endif	/* __STDC__	*/
			/* This value should match NOFILES_MAX in
			   param.h, which is the maximum allowable
			   value for NOFILE - the maximum number of
...
#if __STDC__ == 0 && !defined(_POSIX_SOURCE) /* non-ANSI standard compilation, exclude under POSIX */
...
#endif	/* STDC==0 && !defined _POSIX_SOURCE */
#endif	/* __STDC__ == 0 */
