...
#ifndef _UTIL_XDEBUG_H	/* wrapper symbol for kernel use */
#define _UTIL_XDEBUG_H	/* subject to change without notice */

#ident	"@(#)uts-x86:util/xdebug.h	1.4"
#ident	"$Header: $"
