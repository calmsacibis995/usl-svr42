...
#ifndef _UTIL_WEITEK_H	/* wrapper symbol for kernel use */
#define _UTIL_WEITEK_H	/* subject to change without notice */
...
#define	WEITEK_20MHz	0x00008000	/* Bit indicating 20 MHz 1163 chip */
