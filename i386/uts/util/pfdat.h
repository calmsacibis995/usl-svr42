...
#ifndef _UTIL_PFDAT_H	/* wrapper symbol for kernel use */
#define _UTIL_PFDAT_H	/* subject to change without notice */

/* This header file, pfdat.h is kept for source compatibility for those
...
#ident	"@(#)uts-x86:util/pfdat.h	1.2"
#ident	"$Header: $"
