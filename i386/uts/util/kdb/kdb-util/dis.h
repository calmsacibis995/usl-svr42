...
#ifndef _UTIL_KDB_KDB_UTIL_DIS_H	/* wrapper symbol for kernel use */
#define _UTIL_KDB_KDB_UTIL_DIS_H	/* subject to change without notice */

#ident	"@(#)uts-x86:util/kdb/kdb-util/dis.h	1.6"
#ident	"$Header: $"
...
#define		TERM 0		/* used in tbls.c to indicate		*/
 ...
 *	used in the addressing modes.  The values are in 'tbls.c'.
 */
struct addr {
	int	disp;
	char	regs[9];
...
/*
 *	These are the instruction formats as they appear in 'tbls.c'
 *	for the adr_mode field of instable structs.  Here they are given
 *	numerical values for use in the actual disassembly of an object file.
 */
#define UNKNOWN	0
#define MRw	2
#define IMlw	3
...
#endif /* _UTIL_KDB_KDB_UTIL_DIS_H */
