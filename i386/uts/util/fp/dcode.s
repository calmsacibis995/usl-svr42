...
/	actual or intended publication of such source code.
	...
	.ident	"@(#)uts-x86:util/fp/dcode.s	1.1"
	.ident	"$Header: $"
...
/ *********************************************************************
/
define(null_fmt,`ifelse(`$1',`',`0b00',`$2',`',`0b00($1)',`0b00($1,$2)')')
define(top_fmt,`ifelse(`$1',`',`0b01',`$2',`',`0b01($1)',`0b01($1,$2)')')
define(topm1_fmt,`ifelse(`$1',`',`0b10',`$2',`',`0b10($1)',`0b10($1,$2)')')
define(topp1_fmt,`ifelse(`$1',`',`0b11',`$2',`',`0b11($1)',`0b11($1,$2)')')
define(op1,`ifelse(`$1',`',`0b1000000',`$2',`',`0b1000000($1)',`0b1000000($1,$2)')')
define(op2,`ifelse(`$1',`',`0b10000',`$2',`',`0b10000($1)',`0b10000($1,$2)')')
define(res1,`ifelse(`$1',`',`0b100',`$2',`',`0b100($1)',`0b100($1,$2)')')
define(res2,`ifelse(`$1',`',`0b1',`$2',`',`0b1($1)',`0b1($1,$2)')')
/
/	transcendental operand/result form at types
/
/ define	fprem_type	op1\*top_fmt+op2\*topm1_fmt+res1\*top_fmt
define(fprem_type,`ifelse(`$1',`',`0x64',`$2',`',`0x64($1)',`0x64($1,$2)')')
/ define	fyl2x_type	op1\*top_fmt+op2\*topm1_fmt+res1\*topm1_fmt
define(fyl2x_type,`ifelse(`$1',`',`0x68',`$2',`',`0x68($1)',`0x68($1,$2)')')
define(fdecstp_type,`ifelse(`$1',`',`null_fmt',`$2',`',`null_fmt($1)',`null_fmt($1,$2)')')
define(fchs_type,`ifelse(`$1',`',`op1\*top_fmt+res1\*top_fmt',`$2',`',`op1\*top_fmt+res1\*top_fmt($1)',`op1\*top_fmt+res1\*top_fmt($1,$2)')')
define(fld1_type,`ifelse(`$1',`',`res1\*topp1_fmt',`$2',`',`res1\*topp1_fmt($1)',`res1\*topp1_fmt($1,$2)')')
define(ftst_type,`ifelse(`$1',`',`op1\*top_fmt',`$2',`',`op1\*top_fmt($1)',`op1\*top_fmt($1,$2)')')
/	define	fptan_type	op1\*top_fmt+res1\*top_fmt+res2\*topp1_fmt
define(fptan_type,`ifelse(`$1',`',`0x47',`$2',`',`0x47($1)',`0x47($1,$2)')')
/	define	fpatan_type	op1\*topm1_fmt+op2\*top_fmt+res1\*topm1_fmt
define(fpatan_type,`ifelse(`$1',`',`0x98',`$2',`',`0x98($1)',`0x98($1,$2)')')
define(fscale_type,`ifelse(`$1',`',`op1\*topm1_fmt+op2\*top_fmt+res1\*top_fmt',`$2',`',`op1\*topm1_fmt+op2\*top_fmt+res1\*top_fmt($1)',`op1\*topm1_fmt+op2\*top_fmt+res1\*top_fmt($1,$2)')')
/
