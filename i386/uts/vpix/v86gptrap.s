...
ifdef(`VPIX',`
	...
	.ident	"@(#)uts-x86:vpix/v86gptrap.s	1.6"
	.ident "$Header: $"
	.file	"vpix/v86gptrap.s"
...
/ NOTE: Users segment registers remain in effect, except for CS,
...
/
/  Cant emulate here.  Force trap to ECT.
/
go_ECT:
...
go_ECT_done:
 	movl    $0, u+u_fault_catch+fc_flags
...
popf_done:
	...
	orw     $IFLAG,%bx              /  Dont let real I bit be off
