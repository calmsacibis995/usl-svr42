...
#ifndef _VPIX_V86_H	/* wrapper symbol for kernel use */
#define _VPIX_V86_H	/* subject to change without notice */

#ident	"@(#)uts-x86:vpix/v86.h	1.4"
#ident "$Header: v86.h 1.1 91/03/05 $"
...
{   struct tss386 xt_tss;               /* Normal TSS structure         */
    ...
    clock_t xt_lbolt;                    /* Lightning bolt value         */
