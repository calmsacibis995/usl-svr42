...
/* segment descriptor as initalized by MKDSCR */

struct i_seg_desc {
	unsigned short s_b0015;		/* base bits  0 - 15 */
	unsigned char  s_b1623;		/* base bits 16 - 23 */
	unsigned char  s_b2431;		/* base bits 24 - 31 */
	unsigned short s_lim0015;	/* limit bits 0-15 */
	unsigned char  s_acc2;		/* access bits + limit 16-19 */
	unsigned char  s_acc1;		/* type and priv bits */
};

/* real segment descriptor used by 80386 */
...
#define XTSSSEL         0x188   /* XTSS for dual-mode processes (VPIX) */
...
struct i_gate_desc {
	unsigned short g_off0015;	/* offset bits	0 - 15 */
	unsigned short g_off1631;	/* offset bits 16 - 31 */
	unsigned short g_sel;		/* selector */
	unsigned char  g_wcount;	/* word count */
	unsigned char  g_type;		/* type of gate and access rights */
};
...
#define GATE_TYPE	0x4		/* Gate type in g_type field	 */
#define DESC_TYPE	0x10		/* Descriptor not gate in g_type */
