...
#ident	"@(#)uts-x86:proc/class.h	1.6"
#ident	"$Header: $"
...
extern char	*initclass;	/* class of init process, from kernel.cf */
...
#define CL_SWAPINPRI(pp, clprocp) (*(pp)->p_clfuncs->cl_swapinpri)(clprocp)

#define CL_SWAPOUT(clp, fmem, justloaded, procpp, unloadokp) \
    (*(clp)->cl_funcs->cl_swapout)(fmem, justloaded, procpp, unloadokp)

#define CL_SWAPOUTPRI(pp, clprocp) (*(pp)->p_clfuncs->cl_swapoutpri)(clprocp)
