...
#ifndef _PROC_OBJ_ELF_H	/* wrapper symbol for kernel use */
#define _PROC_OBJ_ELF_H	/* subject to change without notice */

#ident	"@(#)uts-x86:proc/obj/elf.h	1.6"
#ident	"$Header: $"
...
#include <sys/elftypes.h> /* SVR4.0COMPAT */
