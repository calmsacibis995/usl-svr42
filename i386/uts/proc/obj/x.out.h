...
#ifndef _PROC_OBJ_X_OUT_H	/* wrapper symbol for kernel use */
#define _PROC_OBJ_X_OUT_H	/* subject to change without notice */

#ident	"@(#)uts-x86:proc/obj/x.out.h	1.2"
#ident "$Header: $"
