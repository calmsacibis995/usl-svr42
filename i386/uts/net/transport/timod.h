...
#ifndef _NET_TRANSPORT_TIMOD_H	/* wrapper symbol for kernel use */
#define _NET_TRANSPORT_TIMOD_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/transport/timod.h	1.3"
#ident	"$Header: $"
