...
#ifndef	_NET_TRANSPORT_SOCKMOD_H	/* wrapper symbol for kernel use */
#define	_NET_TRANSPORT_SOCKMOD_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/transport/sockmod.h	1.4"
#ident	"$Header: $"
...
#ifndef _NET_TRANSPORT_UN_H
#include <net/transport/un.h>		/* REQUIRED */
#endif
...
#endif /* _NET_TRANSPORT_SOCKMOD_H */
