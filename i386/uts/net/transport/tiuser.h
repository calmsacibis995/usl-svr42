...
#ifndef _NET_TRANSPORT_TIUSER_H	/* wrapper symbol for kernel use */
#define _NET_TRANSPORT_TIUSER_H	/* subject to change without notice */
#define _SYS_TIUSER_H

#ident	"@(#)uts-x86:net/transport/tiuser.h	1.2"
#ident	"$Header: $"
