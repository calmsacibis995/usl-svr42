...
#ifndef _NET_TRANSPORT_SOCKETVAR_H	/* wrapper symbol for kernel use */
#define _NET_TRANSPORT_SOCKETVAR_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/transport/socketvar.h	1.3"
#ident	"$Header: $"
...
#endif	/* _NET_TRANSPORT_SOCKETVAR_H */
