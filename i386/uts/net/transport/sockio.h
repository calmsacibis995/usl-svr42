...
#ifndef	_NET_TRANSPORT_SOCKIO_H	/* wrapper symbol for kernel use */
#define	_NET_TRANSPORT_SOCKIO_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/transport/sockio.h	1.4"
#ident	"$Header: $"
