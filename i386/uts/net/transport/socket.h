...
#ifndef	_NET_TRANSPORT_SOCKET_H	/* wrapper symbol for kernel use */
#define	_NET_TRANSPORT_SOCKET_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/transport/socket.h	1.5"
#ident	"$Header: $"
