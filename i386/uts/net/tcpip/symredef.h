...
#ifndef	_NET_TCPIP_SYMREDEF_H	/* wrapper symbol for kernel use */
#define	_NET_TCPIP_SYMREDEF_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/tcpip/symredef.h	1.3"
#ident	"$Header: $"
