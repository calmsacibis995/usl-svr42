...
#ifndef _NET_TCPIP_STRIOC_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_STRIOC_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/tcpip/strioc.h	1.3"
#ident	"$Header: $"
