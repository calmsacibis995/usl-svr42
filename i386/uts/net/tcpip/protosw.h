...
#ifndef _NET_TCPIP_PROTOSW_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_PROTOSW_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/tcpip/protosw.h	1.4"
#ident	"$Header: $"
