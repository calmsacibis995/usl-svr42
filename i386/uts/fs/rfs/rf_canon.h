...
#ifndef _FS_RFS_RF_CANON_H	/* wrapper symbol for kernel use */
#define _FS_RFS_RF_CANON_H	/* subject to change without notice */

#ident	"@(#)uts-x86:fs/rfs/rf_canon.h	1.6"
#ident	"$Header: $"
...
#define DVSTAT_FMT	"ssllss"
#define ACL_FMT		"ils"	/* actually int, long, unsigned short */
#define UTIME_FMT	"ll"
...
#define DVSTAT_XP	(4 * SXPAND)
#define ACL_XP		(IXPAND +0+0)/* last short in a long by compiler */
 ...
 */
extern int	rf_acltcanon();
extern int	rf_aclfcanon();
