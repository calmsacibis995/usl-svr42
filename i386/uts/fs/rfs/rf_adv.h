...
#ifndef _FS_RFS_RF_ADV_H	/* wrapper symbol for kernel use */
#define _FS_RFS_RF_ADV_H	/* subject to change without notice */

#ident	"@(#)uts-x86:fs/rfs/rf_adv.h	1.6"
#ident	"$Header: $"
/*
...
typedef struct sr_mount {
	...
	ulong 		srm_kbcnt;	/* Kbytes read/written by this client */
