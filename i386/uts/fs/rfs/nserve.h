...
#ifndef _FS_RFS_NSERVE_H	/* wrapper symbol for kernel use */
#define _FS_RFS_NSERVE_H	/* subject to change without notice */
#define _SYS_NSERVE_H

#ident	"@(#)uts-x86:fs/rfs/nserve.h	1.3"
#ident	"$Header: $"
/*
