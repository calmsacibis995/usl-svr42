...
#ifndef _FS_RFS_HETERO_H	/* wrapper symbol for kernel use */
#define _FS_RFS_HETERO_H	/* subject to change without notice */

#ident	"@(#)uts-x86:fs/rfs/hetero.h	1.3"
#ident	"$Header: $"
