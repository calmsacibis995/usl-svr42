...
/*
 * Ioctl's have the command encoded in the lower two bytes,
 * and the size of any in or out parameters in the third byte.
 * The high 2 bits of the upper (fourth) byte are used
