...
#ifndef _IO_OSOCKET_OSOCKET_H	/* wrapper symbol for kernel use */
#define _IO_OSOCKET_OSOCKET_H	/* subject to change without notice */

#ident	"@(#)uts-x86:io/osocket/osocket.h	1.3"
#ident	"$Header: $"

#ifdef _KERNEL_HEADERS

#ifndef _NET_TRANSPORT_SOCKMOD_H
#include <net/transport/sockmod.h>	/* REQUIRED */
#endif
...
/* These definations are here because some of them differ from SVR4.0 socket.h */
 ...
 * compatibility.   
 */
#define	OPRCO_GETOPT	0
#define	OPRCO_SETOPT	1

#define	OPRCO_NCMDS	2

extern struct oprotosw *opffindproto();
extern struct oprotosw *opffindtype();
