...
#ifndef _IO_POLL_H
#include <io/poll.h>	/* SVR4.0COMPAT */
#endif

#ifndef _IO_STRMDEP_H
...
#include <sys/poll.h>		/* SVR4.0COMPAT */
...
struct equeue {
	...
	unsigned char	eq_blocked;	/* number of bands flow controlled */
};

#define q_link	q_eq->eq_link
#define q_bandp	q_eq->eq_bandp
#define q_nband	q_eq->eq_nband
#define q_blocked q_eq->eq_blocked
