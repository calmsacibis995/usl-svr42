...
#ifndef	_IO_OSXT_SXT_H	/* wrapper symbol for kernel use */
#define	_IO_OSXT_SXT_H	/* subject to change without notice */

#ident	"@(#)uts-x86:io/osxt/sxt.h	1.3"
#ident	"$Header: $"
