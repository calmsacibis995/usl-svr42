...
#ifndef _IO_XT_NXTPROTO_H	/* wrapper symbol for kernel use */
#define _IO_XT_NXTPROTO_H	/* subject to change without notice */

#ident	"@(#)uts-x86:io/xt/nxtproto.h	1.3"
#ident	"$Header: $"
