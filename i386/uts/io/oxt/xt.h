...
#ifndef _IO_OXT_XT_H	/* wrapper symbol for kernel use */
#define _IO_OXT_XT_H	/* subject to change without notice */

#ident	"@(#)uts-x86:io/oxt/xt.h	1.3"
#ident	"$Header: $"
...
#ifndef _IO_XT_JIOCTL_H
#include <io/xt/jioctl.h> 	/* REQUIRED */
#endif

#ifndef _IO_TTY_H
#include <io/tty.h> 		/* REQUIRED */
#endif

#ifndef _IO_OXT_XTPROTO_H
#include <io/oxt/xtproto.h> 	/* REQUIRED */
#endif
...
#include <sys/jioctl.h> 	/* REQUIRED */
#include <sys/tty.h> 		/* REQUIRED */
#include <sys/xtproto.h> 	/* REQUIRED */
