...
#ifndef _IO_OXT_XTPROTO_H	/* wrapper symbol for kernel use */
#define _IO_OXT_XTPROTO_H	/* subject to change without notice */

#ident	"@(#)uts-x86:io/oxt/xtproto.h	1.3"
#ident	"$Header: $"
...
#define GET_BITS(byte,pos,len,mask)     ((unsigned char)(byte & mask) >> (unsigned char) pos)
