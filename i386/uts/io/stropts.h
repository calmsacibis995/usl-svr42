...
struct adtrecvfd {
	...
	int	adtrfd_sendfd;		/* Sender's file descriptor number of
					** the file to be received
					*/
	pid_t	adtrfd_recvpid;		/* Receiver's process id */  
	int	adtrfd_recvfd;		/* Receiver's file descriptor number of
