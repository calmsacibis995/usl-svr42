...
#ifndef _IO_SXT_NSXT_H	/* wrapper symbol for kernel use */
#define _IO_SXT_NSXT_H	/* subject to change without notice */

#ident	"@(#)uts-x86:io/sxt/nsxt.h	1.3"
#ident	"$Header: $"
