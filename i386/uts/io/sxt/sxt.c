...
#ident	"@(#)uts-x86:io/sxt/sxt.c	1.7"
#ident	"$Header: $"
...
#include <svc/errno.h>
#include <io/strtty.h>
#include <io/sxt/nsxt.h>
#include <fs/fcntl.h>
#include <util/cmn_err.h>
#include <util/mod/moddefs.h>

MOD_DRV_WRAPPER(nsxt, NULL, NULL, NULL, "nsxt - driver for shell layers");
...
queue_t *q;
{
	...
	for( i=start; i<MAXPCHAN; i++)
	{
		...
		if( chanp->schan_upq && WR(chanp->schan_upq) )  /* upper write queue there? */
		{
			count += sxtqsrv(chanp);
