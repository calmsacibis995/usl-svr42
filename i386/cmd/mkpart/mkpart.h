...
#ident	"@(#)mkpart:i386/cmd/mkpart/mkpart.h	1.1.2.3"
#ident	"$Header: mkpart.h 1.1 91/05/29 $"
...
typedef struct partstanza {
	...
	ushort	ps_partno;	/* partition number in vtoc */
...
#define UNDEFINED_SECTOR	0xffffffffu	/* invalid sector number, size */
...
#define ADDBADSEC	0x01
#define PRINTBBL	0x02
#define PRINTMFBBL	0x03
#define VER_WRITE	1	/* verify flag writing */
#define VER_READ	2	/* verify flag reading */

/* defines from hd.h --- it was removed in p9 */
#define	HIOC		('H'<<8)
