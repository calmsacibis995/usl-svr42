...
#ident	"@(#)truss:i386/cmd/truss/systable.c	1.1.3.2"
#ident  "$Header: systable.c 1.4 91/07/25 $"
#include <stdio.h>
#include <sys/types.h>
#include <sys/param.h>
...
CONST	struct systable systable[] = {
 ...
 {"sysi86",	4, HEX, NOV, PSYS, HEX, HEX, HEX, DEC, DEC},	      /* 50 */
 ...
 {"sysisc",	4, DEC, HEX, DEC, HEX, HEX, HEX},		      /* 105 */
 ...
 { NULL,	8, HEX, HEX, HEX, HEX, HEX, HEX, HEX, HEX, HEX, HEX}, /* 143 */
 ...
 {NULL, 0, NOV, NOV},	/* 168 - 196 new for ESMP: not implemented yet */
 {NULL, 0, NOV, NOV},
 {NULL, 0, NOV, NOV},
 {NULL, 0, NOV, NOV},
 {NULL, 0, NOV, NOV},
 ...
 { "modstat", 3, DEC, NOV, DEC, HEX, BOO},                            /* 200 */
 { "modadm", 3, DEC, NOV, MDT, MDC, HEX },                            /* 201 */
 { "getksym", 3, DEC, NOV, STG, IHX, IHX },                           /* 202*/
 { NULL,	-1,DEC, NOV},					      /* end */
};
...
static	CONST	struct systable isctable[] = {
 { NULL,		1, NOV, NOV, HID},			/* 0 */
 {"setostype_isc",	2, DEC, NOV, HID, DEC},			/* 1 */
 {"rename_isc",		3, DEC, NOV, HID, STG, STG},		/* 2 */
 {"sigaction_isc",	4, DEC, NOV, HID, SIG, HEX, HEX},	/* 3 */
 {"sigprocmask_isc",	4, DEC, NOV, HID, DEC, HEX, HEX},	/* 4 */
 {"sigpending_isc",	2, DEC, NOV, HID, HEX},			/* 5 */
 {"getgroups_isc",	3, DEC, NOV, HID, DEC, HEX},		/* 6 */
 {"setgroups_isc",	3, DEC, NOV, HID, DEC, HEX},		/* 7 */
 {"pathconf_isc",	3, DEC, NOV, HID, STG, DEC},		/* 8 */
 {"fpathconf_isc",	3, DEC, NOV, HID, DEC, DEC},		/* 9 */
 {"sysconf_isc",	2, DEC, NOV, HID, DEC},			/* 10 */
 {"waitpid_isc",	4, DEC, HEX, HID, DEC, HEX, HEX},	/* 11 */
 {"setsid_isc",		1, DEC, NOV, HID},			/* 12 */
 {"setpgid_isc",	3, DEC, NOV, HID, DEC, DEC},		/* 13 */
 { NULL,		1, NOV, NOV, HID},			/* 14 */
 { NULL,		1, NOV, NOV, HID},			/* 15 */
 {"fsync_isc",		2, DEC, NOV, HID, DEC},			/* 16 */
};
#define	NISCCODE	(sizeof(isctable)/sizeof(struct systable))
...
register int subcode;
{
	...
	if (subcode != -1) {
		...
		case SYS_hrtsys:	/* hrtsys() */
			...
			break;
		case SYS_sysisc:	/* sysisc() */
			if ((unsigned)subcode < NISCCODE
			    && isctable[subcode].name != NULL)
				stp = &isctable[subcode];
			break;
		}
	}
