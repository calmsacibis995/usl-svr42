...
#ident	"@(#)optim:i386/imull.c	1.1.1.4"
/* imull.c
**
...
#define LEALSIZE (1+4+1+4+1+1+1+1)	/* for "(%exx,%exx,8)\0" */
...
char * livereg;				/* register in node to be set live */
{
	...
	INSNODE(new, pn);		/* append new node after current */
