...
#else
#define FIRSTSEG_ORIGIN (Addr)(STACKGAP + 0x00300000)
#endif
...
#define SHN_REL_NAME	".rel"
#define REL_GOT		".rel.got"
...
#define	PLT_SEG	TEXT_SEG
#define	PLTGOT_SECT	got_sect
#define PRELS	0
#define	NOP_SPACE	0	/* is not needed on i386 */
