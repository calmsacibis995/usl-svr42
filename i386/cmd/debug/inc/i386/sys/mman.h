...
#ident	"@(#)debugger:inc/i386/sys/mman.h	1.1"
/* System header included here to get around
 * incorrect prototype for mmap and missign declaration of
 * munmap - THIS SHOULD GO AWAY
 */
