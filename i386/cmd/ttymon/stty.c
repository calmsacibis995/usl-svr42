...
#ident	"@(#)ttymon:i386/cmd/ttymon/stty.c	1.12.8.2"
#ident "$Header: /sms/sinixV5.4es/rcs/s19-full/usr/src/cmd/ttymon/stty.c,v 1.1 91/02/28 20:16:00 ccs Exp $"
...
static const char USAGE[] = ":588:Usage: stty [-ag] [modes]\n";
static int	pitt = 0;
