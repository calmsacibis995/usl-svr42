...
#ident	"@(#)sdb:libmachine/i386/dis.h	1.4"
...
#define REG_ONLY	3		/* this indicates a single register with no */
							/* displacement is an operand */
...
#define ADDLW	0x81
#define	ADDLB	0x83
#define	MAXERRS	10	 /* maximum # of errors allowed before abandoning
						this disassembly */
#define 	OPLEN	35	/*	maximum length of a single operand (will
