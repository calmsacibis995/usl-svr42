...
#ifndef _NET_TCPIP_LIHDR_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_LIHDR_H	/* subject to change without notice */

#ident	"@(#)uts-x86:net/tcpip/lihdr.h	1.2"
#ident	"$Header: $"
