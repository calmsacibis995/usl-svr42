...
#ifndef _NET_YHTPIP_PROTOSW_H	/* wrapper symbol for kernel use */
#define _NET_YHTPIP_PROTOSW_H	/* subject to change without notice */
...
#ifdef _KERNEL
extern	struct protosw *yhpffindproto(), *yhpffindtype();
#endif

#endif	/* _NET_YHTPIP_PROTOSW_H */
