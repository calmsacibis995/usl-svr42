...
#ifndef _NET_TCPIP_NIHDR_H	/* wrapper symbol for kernel use */
#define _NET_TCPIP_NIHDR_H	/* subject to change without notice */

#ident	"@(#)uts-comm:net/tcpip/nihdr.h	1.2.3.1"
#ident	"$Header: $"
