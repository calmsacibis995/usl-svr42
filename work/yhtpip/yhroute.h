...
#ifdef	STRNET
mblk_t	*yhrthost[RTHASHSIZ];
mblk_t	*yhrtnet[RTHASHSIZ];
#else
struct	mbuf *yhrthost[RTHASHSIZ];
struct	mbuf *yhrtnet[RTHASHSIZ];
#endif	/* STRNET */

struct	rtstat	yhrtstat;
#endif	/* _KERNEL */
#endif /* _NET_HYTPIP_YHROUTE_H */
