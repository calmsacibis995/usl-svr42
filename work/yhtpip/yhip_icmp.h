...
#ifndef _NET_YHTPIP_YHIP_ICMP_H	/* wrapper symbol for kernel use */
#define _NET_YHTPIP_YHIP_ICMP_H	/* subject to change without notice */
...
#ifndef _NET_YHTPIP_YHIP_H
#include <net/yhtpip/yhip.h>	/* REQUIRED */
#endif
